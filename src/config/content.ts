...
export const cardSections = {
  ...
  love: {
    ...
    cards: [
      { image: "/images/cards/love-1.jpg", badge: "연애", tag: "NEW",  name: "자미두수", desc: "명반 속 12개 별자리로 읽는 100년 인생 흐름", href: "/saju/jamisusu" },
      { image: "/images/cards/love-2.mp4", type: "video" as const, badge: "연애", tag: "인기", name: "자미두수 연애운",    desc: "동양의 별자리가 알려주는 나의 연애운과 솔로탈출 시기",         href: "/saju/jamisusu-love" },
      { image: "/images/cards/love-3.mp4", type: "video" as const, badge: "자미두수", tag: "인기", name: "자미두수 궁합",    desc: "동양의 별자리로 보는 궁합과 상대의 마음 크기",                   href: "/saju/jamisusu-compat" },
      { image: "/images/cards/love-4.mp4", type: "video" as const, badge: "자미두수", tag: "NEW", name: "자미두수 임신운",      desc: "동양의 별자리가 알려주는 임신 시기와 아이 성별",                 href: "/saju/jamisusu-baby" },
      { image: "/images/cards/love-5.jpg", badge: "자미두수", tag: "NEW", name: "자미두수 재회운",    desc: "동양의 별자리가 알려주는 너의 속마음과 재회가능성",               href: "/saju/jamisusu-reunion" },
      { image: "/images/cards/love-6.jpg", badge: "자미두수", tag: "NEW", name: "자미두수 결혼운", desc: "별자리 속 운명의 상대, 나의 배우자의 모습과 결혼운 시기",      href: "/saju/jamisusu-marriage" },
      { image: "/images/cards/love-7.jpg", badge: "자미두수", tag: "NEW", name: "자미두수 갈등 궁합",   desc: "사주가 답 못하는 질문, 부처궁이 풀어드려요",                  href: "/saju/jamisusu-conflict" },
      { image: "/images/cards/love-8.jpg", badge: "자미두수", tag: "NEW", name: "자미두수", desc: "인생 12궁과 14주성으로 향후 10년 기운 흐름을 분석합니다",          href: "/saju/jamisusu-life" },
    ],
  },
  ...
  baby: {
    ...
    cards: [
      { image: "/images/cards/baby-1.jpg", badge: "가정", tag: "추천", name: "임신 사주",       desc: "임신 시기와 아이 성별을 사주로 분석합니다",   href: "/saju/pregnancy" },
      { image: "/images/cards/baby-2.jpg", badge: "가정",              name: "영재 사주",       desc: "우리 아이는 어떤 영재일까",                   href: "/saju/gifted" },
      { image: "/images/cards/baby-3.jpg", badge: "가정", tag: "NEW",  name: "자녀 사주",       desc: "타고난 재능과 맞춤 양육법 분석",              href: "/saju/child" },
      { image: "/images/cards/baby-4.jpg", badge: "가정",              name: "태명 작명",       desc: "사주에 맞는 좋은 태명과 이름 짓기",           href: "/saju/naming" },
      { image: "/images/cards/baby-5.jpg", badge: "가정", tag: "인기", name: "부부 궁합",       desc: "결혼 후 부부 사이의 운세 흐름",               href: "/saju/couple-compat" },
      { image: "/images/cards/baby-6.jpg", badge: "가정", tag: "추천", name: "합궁 택일",       desc: "임신 길일과 합궁 택일 분석",                  href: "/saju/hapgung" },
    ],
  },
  ...
  compat: {
    ...
    cards: [
      ...
      { image: "/images/cards/love2-4.jpg", badge: "연애", tag: "추천", name: "부부 궁합",      desc: "결혼 후 부부 사이의 운세 흐름",             href: "/saju/couple-compat" },
  ...
  career: {
    ...
    cards: [
      ...
      { image: "/images/cards/reunion-4.jpg", badge: "재회",              name: "베딕 재회",      desc: "인도 점성술로 보는 재회 시기와 확률",      href: "/saju/vedic-reunion" },
  ...
  health: {
    ...
    layout: "large" as const,
    cards: [
      { image: "/images/cards/compat2-1.jpg", badge: "궁합", tag: "NEW",  name: "연애 궁합 분석", desc: "사주로 보는 두 사람의 궁합 분석",         href: "/saju/love-compat" },
      { image: "/images/cards/compat2-2.jpg", badge: "궁합",              name: "종합 궁합",      desc: "인연의 시기와 운명적 만남 분석",           href: "/saju/total-compat" },
      { image: "/images/cards/compat2-3.jpg", badge: "궁합", tag: "추천", name: "띠 궁합",        desc: "띠로 보는 기본 궁합 풀이",                 href: "/saju/zodiac-compat" },
      { image: "/images/cards/compat2-4.jpg", badge: "궁합",              name: "부부 궁합",      desc: "결혼 후 부부 사이의 운세 흐름",             href: "/saju/couple-compat" },
      { image: "/images/cards/compat2-5.jpg", badge: "궁합", tag: "인기", name: "비즈니스 궁합",  desc: "동업·사업 파트너 궁합 분석",               href: "/saju/biz-compat" },
      { image: "/images/cards/compat2-6.jpg", badge: "궁합", tag: "NEW",  name: "자미두수 궁합",  desc: "동양 별자리로 보는 심층 궁합 분석",         href: "/saju/jamisusu-compat" },
      { image: "/images/cards/compat2-7.jpg", badge: "궁합",              name: "합궁 사주",      desc: "두 사람의 에너지가 맞는 최적의 시기",       href: "/saju/hapgung" },
    ],
  },
  ...
  total: {
    ...
    cards: [
      ...
      { image: "/images/cards/total-2.jpg", badge: "종합",               name: "오늘의 일진",   desc: "하루의 기운을 사주로 읽는 일진 풀이",         href: "/saju/daily" },
      { image: "/images/cards/total-3.jpg", badge: "종합", tag: "NEW",   name: "신년 사주",     desc: "새해 한 해 전체 운세 종합 분석",               href: "/saju/new-year" },
      { image: "/images/cards/total-4.jpg", badge: "종합", tag: "인기",  name: "사주 기본 감명", desc: "사주 4기둥으로 보는 타고난 성향",             href: "/saju/basic" },
  ...
  wellbeing: {
    ...
    cards: [
      ...
      { image: "/images/cards/health-4.jpg", badge: "건강", tag: "인기", name: "오늘의 건강운", desc: "오늘 내 건강 기운은 어떤가요",               href: "/saju/health-daily" },
    ],
  },
};
