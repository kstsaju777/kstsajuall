 ...
 *
 * 📁 이미지 위치
 *   히어로  → public/media/hero/hero-1.jpg ~ hero-11.jpg
 *   카드    → public/media/cards/love/love-1.jpg 등 (아래 경로 참고)
 *
 * 💡 이미지 교체 방법
 *   1. public/media/... 폴더에 파일 붙여넣기
...
export const cardSections = {
  ...
  love: {
    ...
    cards: [
      { image: "/media/cards/love/love-1.jpg", badge: "연애", tag: "NEW",  name: "자미두수", desc: "명반 속 12개 별자리로 읽는 100년 인생 흐름", href: "/saju/jamisusu" },
      { image: "/media/cards/love/love-2.mp4", type: "video" as const, badge: "연애", tag: "인기", name: "자미두수 연애운",    desc: "동양의 별자리가 알려주는 나의 연애운과 솔로탈출 시기",         href: "/saju/jamisusu-love" },
      { image: "/media/cards/love/love-3.mp4", type: "video" as const, badge: "자미두수", tag: "인기", name: "자미두수 궁합",    desc: "동양의 별자리로 보는 궁합과 상대의 마음 크기",                   href: "/saju/jamisusu-compat" },
      { image: "/media/cards/love/love-4.mp4", type: "video" as const, badge: "자미두수", tag: "NEW", name: "자미두수 임신운",      desc: "동양의 별자리가 알려주는 임신 시기와 아이 성별",                 href: "/saju/jamisusu-baby" },
      { image: "/media/cards/love/love-5.jpg", badge: "자미두수", tag: "NEW", name: "자미두수 재회운",    desc: "동양의 별자리가 알려주는 너의 속마음과 재회가능성",               href: "/saju/jamisusu-reunion" },
      { image: "/media/cards/love/love-6.jpg", badge: "자미두수", tag: "NEW", name: "자미두수 결혼운", desc: "별자리 속 운명의 상대, 나의 배우자의 모습과 결혼운 시기",      href: "/saju/jamisusu-marriage" },
      { image: "/media/cards/love/love-7.jpg", badge: "자미두수", tag: "NEW", name: "자미두수 갈등 궁합",   desc: "사주가 답 못하는 질문, 부처궁이 풀어드려요",                  href: "/saju/jamisusu-conflict" },
      { image: "/media/cards/love/love-8.jpg", badge: "자미두수", tag: "NEW", name: "자미두수", desc: "인생 12궁과 14주성으로 향후 10년 기운 흐름을 분석합니다",          href: "/saju/jamisusu-life" },
    ],
  },
  ...
  baby: {
    ...
    cards: [
      ...
      { image: "/media/cards/baby/baby-5.jpg", badge: "가정", tag: "인기", name: "부부 궁합",       desc: "결혼 후 부부 사이의 운세 흐름",               href: "/saju/couple-compat" },
      { image: "/media/cards/baby/baby-6.jpg", badge: "가정", tag: "추천", name: "합궁 택일",       desc: "임신 길일과 합궁 택일 분석",                  href: "/saju/hapgung" },
    ],
  },
  ...
  compat: {
    ...
    cards: [
      ...
      { image: "/media/cards/love2/love2-4.jpg", badge: "연애", tag: "추천", name: "부부 궁합",      desc: "결혼 후 부부 사이의 운세 흐름",             href: "/saju/couple-compat" },
  ...
  career: {
    ...
    layout: "medium" as const,
    cards: [
      { image: "/media/cards/reunion/reunion-1.jpg", badge: "재회", tag: "추천", name: "재회 사주",      desc: "헤어진 그 사람과 다시 만날 수 있을까",     href: "/saju/reunion" },
      ...
      { image: "/media/cards/reunion/reunion-4.jpg", badge: "재회",              name: "베딕 재회",      desc: "인도 점성술로 보는 재회 시기와 확률",      href: "/saju/vedic-reunion" },
  ...
  health: {
    ...
    layout: "large" as const,
    cards: [
      { image: "/media/cards/compat2/compat2-1.jpg", badge: "궁합", tag: "NEW",  name: "연애 궁합 분석", desc: "사주로 보는 두 사람의 궁합 분석",         href: "/saju/love-compat" },
      { image: "/media/cards/compat2/compat2-2.jpg", badge: "궁합",              name: "종합 궁합",      desc: "인연의 시기와 운명적 만남 분석",           href: "/saju/total-compat" },
      { image: "/media/cards/compat2/compat2-3.jpg", badge: "궁합", tag: "추천", name: "띠 궁합",        desc: "띠로 보는 기본 궁합 풀이",                 href: "/saju/zodiac-compat" },
      { image: "/media/cards/compat2/compat2-4.jpg", badge: "궁합",              name: "부부 궁합",      desc: "결혼 후 부부 사이의 운세 흐름",             href: "/saju/couple-compat" },
      { image: "/media/cards/compat2/compat2-5.jpg", badge: "궁합", tag: "인기", name: "비즈니스 궁합",  desc: "동업·사업 파트너 궁합 분석",               href: "/saju/biz-compat" },
      { image: "/media/cards/compat2/compat2-6.jpg", badge: "궁합", tag: "NEW",  name: "자미두수 궁합",  desc: "동양 별자리로 보는 심층 궁합 분석",         href: "/saju/jamisusu-compat" },
      { image: "/media/cards/compat2/compat2-7.jpg", badge: "궁합",              name: "합궁 사주",      desc: "두 사람의 에너지가 맞는 최적의 시기",       href: "/saju/hapgung" },
    ],
  },
  ...
  marriage: {
    ...
    layout: "medium" as const,
    cards: [
      { image: "/media/cards/marriage/marriage-1.jpg", badge: "결혼", tag: "추천", name: "배우자 사주",    desc: "내 운명의 상대 외모·성격·직업 분석",       href: "/saju/spouse" },
  ...
  wellbeing: {
    ...
    cards: [
      ...
      { image: "/media/cards/health/health-4.jpg", badge: "건강", tag: "인기", name: "오늘의 건강운", desc: "오늘 내 건강 기운은 어떤가요",               href: "/saju/health-daily" },
    ],
  },
};
