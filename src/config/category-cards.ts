...
export const CATEGORY_CARDS: Record<string, CategoryCard[]> = {
  ...
  재회: [
    { image: "/images/cards/reunion-1.jpg", badge: "재회", tag: "추천", name: "재회 사주",      desc: "헤어진 그 사람과 다시 만날 수 있을까",        href: "/saju/jeongtong" },
  ],

  결혼: [
    { image: "/images/cards/marriage-1.jpg", badge: "결혼", tag: "추천", name: "배우자 사주",    desc: "내 운명의 상대 외모·성격·직업 분석",         href: "/saju/jeongtong" },
  ],
