...
export const CATEGORY_CARDS: Record<string, CategoryCard[]> = {
  ...
  기타: [
    ...
    { image: "/media/cards/saju_total/total-img-1.jpg", videoUrl: "/media/cards/saju_total/total-0.mp4", badge: "종합", tag: "BEST", tag2: "사주", name: "정통명리 종합사주", tagline: "내 인생 완전 정복하자", desc: "기질·직업·연애·재물·건강·대운·세운 종합풀이", shortDesc: "직업·재물·연애·건강·흐름 내 인생 종합", href: "/saju/total" },
  ],
