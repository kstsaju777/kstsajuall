        ...
        {slides.map((slide, i) => {
          ...
          return (
            <Link
              key={i}
              href={slide.href}
              className="relative flex-shrink-0 overflow-hidden rounded-3xl cursor-pointer block [transform:translateZ(0)]"
              style={{
                width: `${CARD_W}%`,
            ...
            >
              ...
              <div className="absolute inset-x-0 top-0 -bottom-px bg-gradient-to-t from-black/85 via-black/20 to-transparent" />
