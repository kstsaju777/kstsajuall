...
export const BUSINESS_KUNGHAP_CHAPTER_SECTIONS: Record<number, string[]> = {
  ...
  6:  ["bizStyle", "roleBalance", "workLife"],
  7:  ["myStyle", "partnerStyle", "styleGap"],
  8:  ["strengths", "shadows", "balance"],
  9:  ["conflictPattern", "crisisPoints", "overcomeTips", "recoveryGuide"],
...
⚠️ 한국어 합성어의 글자를 절대 변형하지 마오. 조사 규칙(와/과, 이/가)을 단어 내부에 적용하면 절대 안 되오. 예: "효과적"을 "효와적"으로, "결과"를 "결와"로 쓰지 마오. 단어 자체의 철자는 그대로 유지하오.`;
  ...
  const schemas: Record<number, string> = {
    ...
    6: `{"bizStyle":{"coupleType":"","coupleIcon":"🤝","paragraphs":[]},"roleBalance":{"items":[{"role":"","icon":"💼","myRatio":50,"desc":""}]},"workLife":{"clips":[{"situation":"","myReaction":"","partnerReaction":""}]}}`,
    7: `{"myStyle":{"label":"","icon":"💼","keywords":[],"styleDesc":"","strengthStyle":"","shadowStyle":""},"partnerStyle":{"label":"","icon":"🗂️","keywords":[],"styleDesc":"","strengthStyle":"","shadowStyle":""},"styleGap":{"compatRating":"보통","compatIcon":"🤝","paragraphs":[],"tips":[]}}`,
    8: `{"strengths":{"items":[{"icon":"✨","title":"","desc":"","effect":""}],"lightSummary":""},"shadows":{"items":[{"icon":"🌙","title":"","desc":"","trigger":"","overcome":""}],"shadowSummary":""},"balance":{"lightRatio":60,"paragraphs":[],"tips":[]}}`,
    9: `{"conflictPattern":{"triggerType":"","triggerIcon":"⚡","callout":"","patterns":[{"title":"","icon":"💢","desc":""}],"reconcile":"","growthTip":""},"crisisPoints":{"items":[{"icon":"⚠️","title":"","desc":"","basis":"","signal":""}]},"overcomeTips":{"items":[{"icon":"💚","title":"","desc":"","tip":""}]},"recoveryGuide":{"callout":"","principles":[{"title":"","desc":""}],"paragraphs":[]}}`,
...
- paragraphs 3개 (홍연 말투):
  ...
  ③ 이 패턴을 가진 상대와 좋은 비즈니스 파트너가 되는 법 (5~7문장, 220자+).`,
    ...
    6: `두 사람이 함께 일하면 어떤 파트너가 될지 풀어주시오. bizStyle: 파트너십 유형명(coupleType)+아이콘(coupleIcon)+풀이단락(3개), roleBalance: 역할분담(4-5개, role+icon+myRatio(0-100)+desc), workLife: 협업 일상 관찰 클립(3개, situation+myReaction+partnerReaction)`,
    7: `두 사람의 비즈니스 스타일 차이를 풀어주시오. myStyle: 나의 비즈니스 스타일(label+icon+keywords 3-4개+styleDesc+strengthStyle[파트너십에서 빛나는 점]+shadowStyle[주의할 패턴]), partnerStyle: 상대방 비즈니스 스타일(동일 구조), styleGap: 스타일 궁합(compatRating[매우 잘 맞음/잘 맞음/보통/주의]+compatIcon+paragraphs 2-3개+tips 3-4개)`,
    8: `두 사람의 사업 파트너십에서 빛(강점)과 그림자(갈등)를 풀어주시오. strengths: 파트너십 강점 items(3개, icon+title+desc+effect[빛나는 장면])+lightSummary, shadows: 파트너십 그림자 items(3개, icon+title+desc+trigger[발생상황]+overcome[극복법])+shadowSummary, balance: 빛 비율(lightRatio 0-100)+풀이단락(2-3개)+균형 팁(3-4개)`,
    9: `두 사람의 사업 파트너십 갈등 패턴과 위기 요인, 극복 방법을 풀어주시오. conflictPattern: 갈등 유형(triggerType+triggerIcon+callout+patterns 2-3개+reconcile+growthTip), crisisPoints: 위기 요인(items 3개, icon+title+desc+basis+signal), overcomeTips: 극복 방법(items 3개, icon+title+desc+tip), recoveryGuide: 극복 원칙(callout+principles 3개+paragraphs 1-2개)`,
