...
⚠️ 점수·근거를 설명하다 보면 "~높다", "~보인다", "~구조이다"처럼 보고서체(-다/-이다)로 새기 쉬우니, 마지막 문장까지 다시 확인해 홍연 말투로만 끝맺으시오.`,
...
⚠️ compatScore는 점수 산정 근거를 조목조목 짚어야 해서 자기도 모르게 "~크다", "~중요하다"처럼 보고서체로 새기 쉬우니, 마지막 문장까지 다시 확인해 홍연 말투로만 끝맺으시오.
