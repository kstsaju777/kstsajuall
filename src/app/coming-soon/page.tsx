...
export default function ComingSoonPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ backgroundColor: "#fdf8f4" }}>
      <div className="text-center space-y-4">
        <p className="text-[13px] tracking-widest" style={{ color: "#9b2335" }}>✦ 준비 중 ✦</p>
        <h1 className="text-[28px] font-black" style={{ color: "#1a1a1a" }}>곧 오픈됩니다</h1>
