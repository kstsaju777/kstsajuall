...
function StepIntro({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center" style={{ backgroundColor: "#0a0c10" }}>
      <img src="/media/cards/kunghap_ehon/ehon-0.jpg" className="absolute inset-0 w-full h-full object-cover object-top opacity-30" alt="" />
      ...
      <div className="px-6 pt-6 pb-2" style={{ backgroundColor: CARD_BG }}>
        ...
        {name && (
          <div className="mb-2">
            ...
            <div className="rounded-2xl px-4 py-3 mt-3" style={{ backgroundColor: "rgba(184,176,251,0.07)", border: "1px solid rgba(184,176,251,0.25)" }}>
              <p className="text-[13px] leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>
                ...
                {isPartner ? " 두 사람의 사주를 함께 보아 이별의 흐름과 재출발의 인연을 풀어드리겠소이다." : " 이 여덟 글자 안에 그대의 이혼 인연과 새 출발의 흐름이 담겨 있소이다."}
              </p>
            </div>
          </div>
        )}
