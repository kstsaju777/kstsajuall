...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/kunghap_ehon/report-preview?${reportParams.toString()}`;
    router.push(`/saju/kunghap_ehon/report-preview?${reportParams.toString()}`);
    if (email) {
      try {
