...
export default function HealthPage() {
  ...
  return (
    <div className="w-full relative" style={{height:"100dvh",backgroundColor:BG,overflow:"hidden"}}>
      ...
      `}</style>
      {[
        {top:"72px",left:"5%",appearDelay:"1s",floatDelay:"1.6s",floatAnim:"floatA",name:"신*우",stars:5,text:"어디가 약한지 짚어줘서 평소 관리에 도움 됐어요 🌿"},
        {top:"24%",left:"52%",appearDelay:"2s",floatDelay:"2.6s",floatAnim:"floatB",name:"권*현",stars:5,text:"건강 관리 시기랑 주의할 점까지 나와서 신기했어요!"},
        {top:"45%",left:"4%",appearDelay:"3s",floatDelay:"3.6s",floatAnim:"floatC",name:"강*민",stars:5,text:"원인 모를 피로가 사주랑 연결되는 게 신기했어요 ㅠ"},
      ].map((r,i)=>(
