...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/saju_health/report-preview?${reportParams.toString()}`;
    router.push(`/saju/saju_health/report-preview?${reportParams.toString()}`);
    if (email) {
      try {
