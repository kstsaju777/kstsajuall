...
const CH_IMAGES: Record<number, string> = {
  0: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
  1: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
  2: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
  3: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
  4: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
  5: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
  6: "/media/cards/saju_gyeolhon/gyeolhon-0.jpg",
};
  ...
  return (
    <div>
      <div className="relative overflow-hidden" style={{ height: 320 }}>
        <img src="/media/cards/saju_gyeolhon/gyeolhon-0.jpg" alt="" className="absolute inset-0 w-full h-full object-cover object-top" />
...
function InitLoading() {
  return (
    <div className="relative flex flex-col items-center justify-center" style={{ minHeight: "100dvh", backgroundColor: "#0a0c10" }}>
      <img src="/media/cards/saju_gyeolhon/gyeolhon-0.jpg"
...
function ReportPreviewInner() {
    ...
    if (id) {
      ...
      fetch("/api/gyeolhon-report", {
        ...
        .then((d) => {
          ...
          setResultId(rid);
          if (rid) {
            router.replace(`/saju/saju_gyeolhon/report-preview?id=${rid}&name=${encodeURIComponent(name)}&gender=${encodeURIComponent(gender)}&ch=0`);
          }
        })
        .catch(() => {})
        .finally(() => setLoading(false));
  ...
  const goTo = (n: number) => {
    ...
    router.push(`/saju/saju_gyeolhon/report-preview?${base}&ch=${n}`);
  };
