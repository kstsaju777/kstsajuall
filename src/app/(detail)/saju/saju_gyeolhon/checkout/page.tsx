  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      <div className="relative overflow-hidden" style={{ height: 240 }}>
        <img src="/media/cards/saju_gyeolhon/gyeolhon-0.jpg" alt=""
...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/saju_gyeolhon/report-preview?${reportParams.toString()}`;
    router.push(`/saju/saju_gyeolhon/report-preview?${reportParams.toString()}`);
    if (email) {
      try {
