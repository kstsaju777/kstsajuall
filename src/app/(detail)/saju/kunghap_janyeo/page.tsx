...
const CHAPTERS = [
  { media: { src: "/media/cards/kunghap_janyeo/kunghap_janyeo-0.jpg" } },
];
...
export default function JanyeoCompatPage() {
  const router = useRouter();
  ...
  return (
    <div className="w-full flex flex-col relative" style={{ backgroundColor: BG }}>
      ...
      <div style={{ backgroundColor: "#111", padding: "32px 20px 40px", fontSize: "initial", lineHeight: "initial" }}>
        <p style={{ fontSize: 13, color: ACCENT_D, fontWeight: 700, marginBottom: 6 }}>자녀궁합</p>
        ...
        <div style={{ background: "#1a1a1a", borderRadius: 16, overflow: "hidden", marginBottom: 8 }}>
          <img src="/media/cards/kunghap_janyeo/kunghap_janyeo-0.jpg" alt="미리보기" style={{ display: "block", width: "100%", height: "auto" }} />
          <div style={{ padding: "20px 20px 24px" }}>
            <p style={{ fontSize: 12, color: ACCENT_D, fontWeight: 700, marginBottom: 4 }}>+20,000자</p>
            <p style={{ fontSize: 22, color: "#fff", fontWeight: 900, marginBottom: 12 }}>2026 자녀궁합</p>
