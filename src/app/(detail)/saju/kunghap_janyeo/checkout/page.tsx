...
const WHITE    = "#ffffff";
const RED      = "#00b4d8";
const RED_SOFT = "#48cae4";
const RED_PALE = "#e0f7fa";
const ROSE     = "#90e0ef";
const GRAY1    = "#1a1a1a";
const GRAY2    = "#444444";
const GRAY3    = "#888888";
    ...
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="relative">
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "18.9%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}${partnerGender === "여아" ? "양" : "군"}이`}</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>잘 맞는 부분은 어떤 측면인지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "25.55%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}${partnerGender === "여아" ? "양" : "군"}이`}</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>안 맞는 부분은 어떤 측면인지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "34.35%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람 사주팔자 글자간</p>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "47.55%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>부모와 아이가</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>서로를 어떤 시각으로 보는지도.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "59.0%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>{`${stripSurname(partnerName)}${partnerGender === "여아" ? "양" : "군"}의 학습 특성과`}</p>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "67.7%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>자라면서 겪게 될</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>인생의 큰 흐름까지 알려드리오.</p>
        </div>
        <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "4.5%", left: "65.0%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
...
// ─── 결제 모달 ────────────────────────────────────────────────────────────────
const PRODUCT = { name: "자녀궁합", original: 49800, discount: 40, price: 29900 };
      ...
      <div className="fixed bottom-0 z-50 overflow-y-auto rounded-t-3xl"
        ...
        <div className="px-5 pt-2 pb-7">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-[18px] font-black" style={{ color: DTXT }}>자녀궁합 결제 안내</h3>
          ...
          <div className="inline-block text-[13px] font-bold px-3.5 py-1.5 rounded-full mb-5"
            style={{ background: "rgba(0,180,216,0.16)", border: `1px solid ${ACCENT}55`, color: "#48cae4" }}>
            총 <span style={{ color: "#00b4d8" }}>{saved.toLocaleString()}원</span> 할인받았어요!
          </div>
          <div className="mb-5">
          ...
          <div className="space-y-1.5 mb-4">
            ...
            <div className="flex items-center justify-between text-[13px]">
              <span style={{ color: "#00b4d8", fontWeight: 700 }}>지금 결제 시 할인 ({PRODUCT.discount}% 특가)</span>
              <span style={{ color: "#00b4d8", fontWeight: 700 }}>-{saved.toLocaleString()}</span>
            </div>
          </div>
          <button onClick={onConfirm}
            className="w-full py-4 rounded-2xl font-black text-[17px] text-white active:scale-[0.99] transition-transform"
            style={{ background: "linear-gradient(135deg, #48cae4, #00b4d8)", boxShadow: "0 6px 20px rgba(0,180,216,0.4)" }}>
            결제하기
          </button>
        ...
        <div className="fixed z-[60] px-6"
          ...
          <div className="relative mx-auto rounded-2xl px-5 py-4"
            ...
            <button onClick={() => setConfirmExit(false)}
              ...
              style={{ background: "linear-gradient(135deg, #48cae4, #00b4d8)" }}>혜택 받고 계속하기</button>
      ...
      <div style={{ position: "fixed", bottom: 100, right: "max(8px, calc(50vw - 232px))", zIndex: 49, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, pointerEvents: "none" }}>
        {toasts.map((t) => (
          <div key={t.id} style={{ animation: "toastInRight 0.35s ease", display: "flex", alignItems: "center", gap: 6, backgroundColor: "rgba(0,0,0,0.7)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 9999, padding: "6px 14px", fontSize: 12, color: "#fff", whiteSpace: "nowrap", backdropFilter: "blur(6px)" }}>
            <span style={{ backgroundColor: TIME_COLORS[t.time] ?? "#0096b4", color: "#fff", fontSize: 10, fontWeight: 700, borderRadius: 9999, padding: "2px 7px" }}>{t.time}</span>
    ...
    <div className="fixed bottom-0 flex items-center gap-3 px-4 z-50"
      ...
      <style>{`
        @keyframes janyeoBtnNeon {
          ...
          33%  { background: #0096b4; box-shadow: 0 0 12px 3px rgba(0,150,180,0.7); }
          66%  { background: #48cae4; box-shadow: 0 0 12px 3px rgba(72,202,228,0.7); }
          100% { background: #00b4d8; box-shadow: 0 0 12px 3px rgba(0,180,216,0.7); }
        }
      ...
      <button onClick={onPay}
        ...
        style={{ animation: "janyeoBtnNeon 3s ease-in-out infinite, janyeoBtnBeat 2s ease-in-out infinite" }}>
        자녀궁합 확인하기
      </button>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 px-8"
      ...
      <style>{`
        ...
        @keyframes glow-pulse { 0%,100%{box-shadow:0 0 8px 2px #00b4d8aa,0 0 20px 4px #008fb055} 50%{box-shadow:0 0 16px 4px #33cceecc,0 0 40px 10px #00b4d888} }
      ...
      <div className="relative w-20 h-20 mb-6">
        ...
        {[0,1,2,3,4,5].map(i => (
          <div key={i} className="absolute w-1 h-1 rounded-full" style={{
            ...
            background: i % 2 === 0 ? "#33ccee" : "#99e8f5",
            boxShadow: `0 0 6px 2px ${i % 2 === 0 ? "#00b4d8" : "#55d8f0"}`,
            animation: `orbit ${2.5 + i * 0.4}s linear infinite`,
            animationDelay: `${i * -0.5}s`,
          }} />
        ))}
        <div className="absolute inset-0 flex items-center justify-center">
          <span style={{ fontSize: 28, filter: "drop-shadow(0 0 8px #00b4d8)" }}>✦</span>
        </div>
      </div>
      <p className="text-[18px] font-bold mb-1" style={{ color: "#fff5ee", fontFamily: "'Noto Serif KR', serif", textShadow: "0 0 20px #00b4d888" }}>
        결과지를 완성하고 있소…
      </p>
      <p key={currentChapter} className="text-[13px] mb-8" style={{ color: "#55d8f0", animation: "title-fade 4s ease-in-out", minHeight: 20 }}>
        {doneCount < TOTAL ? CHAPTER_TITLES[currentChapter - 1] + " 풀이 중" : "마무리 중이오…"}
      </p>
      <div className="w-full max-w-[280px] mb-3">
        <div className="flex justify-between text-[11px] mb-2" style={{ color: "#0099bb" }}>
          <span>{doneCount} / {TOTAL} 장 완성</span>
          <span>{pct}%</span>
        </div>
        <div className="w-full h-3 rounded-full overflow-hidden relative" style={{ background: "#001520" }}>
          <div className="h-full rounded-full relative overflow-hidden transition-all duration-700"
            style={{ width: `${pct}%`, background: "linear-gradient(90deg, #005566, #00b4d8, #55d8f0)", animation: pct > 0 ? "glow-pulse 1.8s ease-in-out infinite" : "none" }}>
      ...
      <p className="text-[11px] text-center leading-relaxed mt-4" style={{ color: "#446688" }}>
...
function CheckoutContent() {
  ...
  const buildOrderBody = useCallback(() => {
    ...
    const partnerGenderApi: "male" | "female" = partnerGender === "여자" || partnerGender === "여성" || partnerGender === "여아" || partnerGender === "female" ? "female" : "male";
      ...
      <div className="w-full h-full overflow-y-auto" style={{ scrollbarWidth: "none", paddingBottom: 80 }}>
        ...
        <div className="relative">
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "26.0%", left: "69%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}${partnerGender === "여아" ? "양" : "군"}`}</p>
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "54.8%", left: "42%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>두 사람 자녀궁합을 보기 전에</p>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}${partnerGender === "여아" ? "양" : "군"}의 사주팔자가`}</p>
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "95.5%", left: "60%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            ...
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}${partnerGender === "여아" ? "양" : "군"}의`}</p>
...
export default function KunghapJanyeoCheckoutPage() {
  return (
    <Suspense fallback={
