...
function localSajuToMsView(saju: LocalSajuResult): MyeongsikView {
  ...
  const now = new Date();
  return { ilgan: saju.dayStem, pillars, daeun: [], seun: [], weolun: [], currentYear: now.getFullYear(), currentMonth: now.getMonth() + 1 };
}
    ...
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="relative">
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "18.9%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람이 헤어지게 된</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>이유가 무엇인지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "27.75%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람 이별의 상처를</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>어떻게 치유해야 할지도</p>
        </div>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "47.55%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          ...
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>미련의 정도까지 알려드리오.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "59.0%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          ...
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>다시 만날 가능성이 있을지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "67.7%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>앞으로 12개월간의</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두사람 재회에너지 흐름까지</p>
        </div>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "91.6%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람이 재회를 하게 된다면</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>어떤 것들을 준비해야 할지도</p>
        </div>
...
const PRODUCT = { name: "재회궁합", original: 49800, discount: 40, price: 29900 };

function PayBottomSheet({ open, onClose, onConfirm }: { open: boolean; onClose: () => void; onConfirm: () => void }) {
        ...
        <div className="fixed inset-0 z-[70]">
          ...
          <div className="fixed z-[71] flex flex-col rounded-2xl overflow-hidden"
            ...
            <div className="flex-shrink-0 flex items-center justify-between px-4 py-2.5" style={{ borderBottom: "1px solid #eee" }}>
              ...
              <button onClick={() => setLegalDoc(null)} className="flex items-center justify-center rounded-full"
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 px-8"
      ...
      <style>{`
        ...
        @keyframes glow-pulse { 0%,100%{box-shadow:0 0 8px 2px #9b2335aa,0 0 20px 4px #7a1a2855} 50%{box-shadow:0 0 16px 4px #c44455cc,0 0 40px 10px #9b233588} }
      ...
      <div className="relative w-20 h-20 mb-6">
        ...
        {[0,1,2,3,4,5].map(i => (
          <div key={i} className="absolute w-1 h-1 rounded-full" style={{
            ...
            background: i % 2 === 0 ? "#c44455" : "#e08090",
            boxShadow: `0 0 6px 2px ${i % 2 === 0 ? "#9b2335" : "#bb4455"}`,
      ...
      <p className="text-[18px] font-bold mb-1" style={{ color: "#fff5ee", fontFamily: "'Noto Serif KR', serif", textShadow: "0 0 20px #9b233588" }}>
        결과지를 완성하고 있소…
      </p>
      <p key={currentChapter} className="text-[13px] mb-8" style={{ color: "#c87080", animation: "title-fade 4s ease-in-out", minHeight: 20 }}>
        {doneCount < TOTAL ? CHAPTER_TITLES[currentChapter - 1] + " 풀이 중" : "마무리 중이오…"}
      </p>
      <div className="w-full max-w-[280px] mb-3">
        <div className="flex justify-between text-[11px] mb-2" style={{ color: "#883344" }}>
          <span>{doneCount} / {TOTAL} 장 완성</span>
          <span>{pct}%</span>
        </div>
        <div className="w-full h-3 rounded-full overflow-hidden relative" style={{ background: "#1a0008" }}>
          <div className="h-full rounded-full relative overflow-hidden transition-all duration-700"
            style={{ width: `${pct}%`, background: "linear-gradient(90deg, #5a1020, #9b2335, #c87080)", animation: pct > 0 ? "glow-pulse 1.8s ease-in-out infinite" : "none" }}>
      ...
      <p className="text-[11px] text-center leading-relaxed mt-4" style={{ color: "#663344" }}>
...
const PRODUCT_INFO = { name: "재회궁합", price: 29900 };
...
function CheckoutContent() {
  ...
  const handleConfirm = async () => {
    ...
    if (!pendingOrderId.current) {
      ...
      try {
        const body = buildOrderBody();
        const r = await fetch("/api/orders/create-guest-kunghap", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) });
      ...
      <div className="w-full h-full overflow-y-auto" style={{ scrollbarWidth: "none", paddingBottom: 80 }}>
        ...
        <div className="relative">
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "54.8%", left: "42%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>두 사람 재회궁합을 보기 전에</p>
        ...
        <MyeongsikSection
          saju={saju} partnerSaju={partnerSaju}
          name={name} partnerName={partnerName}
          date={date} calendar={calendar} gender={gender}
          partnerDate={partnerDate} partnerCalendar={partnerCalendar} partnerGender={partnerGender}
        />
        ...
        <div className="relative">
          ...
          <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "2.5%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
            <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람 재회의 모든 것을</p>
          ...
          <div className="fixed bottom-0 z-[60] rounded-t-3xl overflow-hidden"
            ...
            <div className="toss-widget-wrap">
              <TossWidget
                ...
                successUrl={`${typeof window !== 'undefined' ? window.location.origin : 'https://www.hongyeondang.com'}/saju/kunghap_jaehwe/checkout/success`}
