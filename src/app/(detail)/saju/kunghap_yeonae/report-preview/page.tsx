        ...
        <div className="px-5 py-6">
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[11.5px]" style={{ color: MUTE }}>홍연이 그대들에게 들려줄 이야기</span>
            </div>
            <button
              onClick={onClose}
...
<>
      ...
      {ch === "0" && (
        <>
          <div className="text-center px-6 py-4" style={{ background: "#111" }}>
            <p className="text-[10px] tracking-[0.25em] mb-2" style={{ color: "rgba(255,255,255,0.5)", fontFamily: SERIF }}>홍연이 그대들에게 들려줄 이야기</p>
            <h1 className="text-[20px] font-black leading-snug" style={{ color: "#fff", fontFamily: SERIF }}>
              연애궁합에 대하여
            </h1>
          </div>
          ...
          <section className="px-6 pt-10 pb-6">
            <P>안녕하시오.</P>
            <P>본격적으로 궁합분석에 들어가기 전에,<br />연애궁합이 무엇인지 먼저 짚고 넘어가겠소.</P>
          </section>
      ...
      {ch === "11" && (
        ...
        <div style={{ filter: eventOpen ? "blur(5px)" : "none", transition: "filter 0.25s ease", pointerEvents: eventOpen ? "none" : "auto" }}>
          ...
          <div className="relative overflow-hidden" style={{ height: 300 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/media/report/kunghap_yeonae/kunghap_yeonae_12/kunghap_yeonae_12_cover.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition: "center 20%" }} />
            <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(17,17,17,1) 0%, rgba(17,17,17,0.3) 35%, transparent 60%, transparent 70%, rgba(253,248,244,1) 100%)" }} />
          </div>
