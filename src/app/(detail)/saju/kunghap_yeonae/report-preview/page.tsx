    ...
    <div className="mx-5 mb-4 rounded-2xl overflow-hidden" style={{ background: WHITE, border: `1px solid ${HAP_COLOR}20`, boxShadow: "0 1px 10px rgba(0,0,0,0.04)" }}>
      ...
      {item.effect && (
        <div className="px-5 py-2.5 flex items-start gap-2" style={{ background: `${HAP_COLOR}05` }}>
          ...
          <p className="text-[12px] leading-relaxed font-medium" style={{ color: HAP_COLOR }}>{item.effect}</p>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="mx-5 mb-5 rounded-2xl overflow-hidden" style={{ background: WHITE, border: `1px solid ${CH6_COLOR}15`, boxShadow: "0 2px 16px rgba(0,0,0,0.05)" }}>
      ...
      <div className="px-5 pt-5 pb-2">
        <h3 className="text-[15px] font-black mb-1" style={{ color: INK }}>종합 궁합 점수</h3>
        <svg viewBox="0 0 220 110" style={{ width: "100%", maxHeight: 130 }}>
          <defs>
      ...
      {/* 합/충 총평 나란히 */}
      {(hapSummary || chungSummary) && (
        <div className="mx-5 mb-4 rounded-xl overflow-hidden" style={{ border: `1px solid ${INK}08` }}>
          {hapSummary && (
            <div className="flex items-start gap-2 px-4 py-2.5" style={{ background: `${HAP_COLOR}06`, borderBottom: chungSummary ? `1px solid ${INK}06` : "none" }}>
              <span className="text-[11px] font-black mt-0.5" style={{ color: HAP_COLOR }}>合</span>
              <p className="text-[12px] leading-relaxed" style={{ color: INK_SOFT }}>{hapSummary}</p>
            </div>
          )}
          {chungSummary && (
            <div className="flex items-start gap-2 px-4 py-2.5" style={{ background: `${CHUNG_COLOR}06` }}>
              <span className="text-[11px] font-black mt-0.5" style={{ color: CHUNG_COLOR }}>沖</span>
              <p className="text-[12px] leading-relaxed" style={{ color: INK_SOFT }}>{chungSummary}</p>
            </div>
          )}
        </div>
      )}
      ...
      {desc && (
        <div className="px-5 pb-5">
          <p className="text-[11px] font-bold mb-2" style={{ color: CH6_COLOR }}>합·충 종합 분석</p>
          <p className="text-[13px] leading-relaxed" style={{ color: INK_SOFT }}>{desc}</p>
        </div>
      )}
    </div>
    ...
    <div className="rounded-2xl overflow-hidden mb-4" style={{ background: WHITE, border: `1.5px solid ${CRISIS_COLOR}25`, boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
      ...
      {item.desc && (
        <div className="px-4 pt-3 pb-2">
          <p className="text-[13.5px] leading-[1.9]" style={{ color: INK, wordBreak: "keep-all" }}>{item.desc}</p>
        </div>
      )}
      {/* 찾아오는 시기 */}
      {item.when && (
        <div className="mx-4 mb-3 rounded-xl px-3 py-2.5" style={{ background: `${CH9_COLOR}08`, border: `1px solid ${CH9_COLOR}18` }}>
          <div className="flex items-start gap-2">
            <span className="text-[12px] font-black flex-shrink-0 mt-0.5" style={{ color: CH9_COLOR }}>🕰</span>
            <div>
              <p className="text-[10px] font-black mb-0.5 tracking-wide" style={{ color: CH9_COLOR }}>찾아오는 때</p>
              <p className="text-[12.5px] leading-relaxed" style={{ color: INK_SOFT }}>{item.when}</p>
            </div>
          </div>
        </div>
      )}
      {/* 위기 신호 */}
      {item.signal && (
        <div className="mx-4 mb-4 rounded-xl px-3 py-2.5" style={{ background: `${CRISIS_COLOR}06`, border: `1px solid ${CRISIS_COLOR}20` }}>
          <div className="flex items-start gap-2">
            <span className="text-[12px] flex-shrink-0 mt-0.5">🚨</span>
            <div>
              <p className="text-[10px] font-black mb-0.5 tracking-wide" style={{ color: CRISIS_COLOR }}>위기 신호</p>
              <p className="text-[12.5px] leading-relaxed" style={{ color: INK_SOFT }}>{item.signal}</p>
            </div>
          </div>
        </div>
      )}
    ...
    <div>
      {overviewDesc && (
        <div className="mx-5 mb-5 rounded-xl px-4 py-3.5" style={{ background: CALLOUT_BG, borderLeft: `3px solid ${CH9_COLOR}` }}>
          <p className="text-[13.5px] leading-[1.85]" style={{ color: INK, wordBreak: "keep-all", fontFamily: SERIF }}>{overviewDesc}</p>
        </div>
      )}
              ...
              <div key={i} className="flex items-start gap-3">
                ...
                <div className="flex-1 rounded-xl overflow-hidden mb-1" style={{ background: s.bg, border: `1px solid ${s.border}` }}>
                  ...
                  <div className="px-3 pt-2.5 pb-2">
                    <p className="text-[13px] leading-[1.8]" style={{ color: INK, wordBreak: "keep-all" }}>{item.text}</p>
                  </div>
                  {/* 이 시기 팁 */}
                  {item.tip && (
    ...
    <div className="space-y-4">
      ...
      {desc && (
        <div className="rounded-xl px-4 py-4" style={{ background: CH10_PALE, border: `1px solid ${CH10_COLOR}20` }}>
          <p className="text-[13.5px] leading-[1.9]" style={{ color: INK, wordBreak: "keep-all" }}>{desc}</p>
        </div>
      )}
      {/* 실천 조언 */}
      {advice && (
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: `1px solid ${WARN}25` }}>
          ...
          {cautionDesc && (
            <div className="px-4 py-3">
              <p className="text-[13px] leading-[1.8]" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>{cautionDesc}</p>
            </div>
          )}
        </div>
      )}
...
function CautionPeriodCard({ item, index }: {
  ...
  return (
    <div className="rounded-2xl overflow-hidden mb-3" style={{ background: WHITE, border: `1.5px solid ${WARN}28` }}>
      ...
      {item.desc && (
        <div className="px-4 pt-3 pb-2">
          <p className="text-[13px] leading-[1.85]" style={{ color: INK, wordBreak: "keep-all" }}>{item.desc}</p>
        </div>
      )}
      {/* 대처법 */}
      {item.cope && (
    ...
    <div>
      {overviewDesc && (
        <div className="mb-5 rounded-xl px-4 py-4" style={{ background: CH11_PALE, borderLeft: `3px solid ${CH11_COLOR}` }}>
          <p className="text-[13.5px] leading-[1.9]" style={{ color: INK, wordBreak: "keep-all", fontFamily: SERIF }}>{overviewDesc}</p>
        </div>
      )}
      {tips.length > 0 && (
          ...
          <div className="px-4 py-3.5 space-y-3.5">
            {tips.map((tip, i) => (
              <div key={i} className="flex items-start gap-3">
                ...
                <p className="text-[13px] leading-[1.8]" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>{tip}</p>
              </div>
            ))}
          </div>
        </div>
...
<>
          ...
          <>
            ...
            <section className="pb-4">
              <div className="px-5 mb-2">
                <p className="text-[11px] font-bold" style={{ color: CH1_COLOR }}>나의 명식</p>
            ...
            <section className="pt-2 pb-2">
              <div className="px-5 mb-3">
                <p className="text-[11px] font-bold" style={{ color: CH1_COLOR }}>일간과 오행</p>
                <h2 className="text-[17px] font-black" style={{ color: INK }}>타고난 기운의 뿌리</h2>
              </div>
              <OhaengDonutCh1 view={report?.view ?? null} />
              {/* 원국 callout */}
              {callout && (
                <div className="mx-5 mb-4 px-4 py-3 rounded-xl" style={{ background: CH1_PALE, borderLeft: `3px solid ${CH1_COLOR}` }}>
                  <p className="text-[13.5px] font-bold leading-relaxed" style={{ color: CH1_COLOR }}>{callout}</p>
                </div>
              )}
              {/* 원국 풀이 단락 */}
              <div className="px-5">
            ...
            <section className="pt-4 pb-2">
              <div className="px-5 mb-3">
                <p className="text-[11px] font-bold" style={{ color: CH1_COLOR }}>나의 기질</p>
            ...
            <section className="pt-4 pb-4">
              <div className="px-5 mb-3">
                <p className="text-[11px] font-bold" style={{ color: CH1_COLOR }}>나의 연애 패턴</p>
            ...
            {/* ── 마무리 인용구 ── */}
            <div className="mx-5 mb-6 px-5 py-4 rounded-2xl text-center" style={{ background: `linear-gradient(135deg, ${CH1_COLOR}10, ${CH1_PALE})`, border: `1px solid ${CH1_COLOR}18` }}>
              <p className="text-[13px] leading-relaxed" style={{ color: CH1_COLOR, fontFamily: SERIF, fontStyle: "italic" }}>
                "나의 기운을 살펴보았으니,<br />이제 상대방의 사주를 펼쳐보겠소."
              </p>
      ...
      {ch === "2" && (() => {
        ...
        const partnerCallout = (partnerWonguk.callout as string | undefined) ?? "";
        return (
          <>
            {/* 다크 헤더 */}
            <div className="text-center px-6 py-4" style={{ background: "#111" }}>
            ...
            <section className="pb-2">
              ...
              {report?.partnerView ? (
                ...
                <p className="px-6 text-[14px]" style={{ color: MUTE }}>상대방 명식 정보가 준비 중이오.</p>
              )}
            </section>

            {/* 오행 도넛 + 원국 풀이 */}
            <section className="pb-4">
              <div className="px-6"><Heading>{partnerName}의 오행과 원국</Heading></div>
              <OhaengDonutCh2 view={report?.partnerView ?? null} />
              {partnerCallout && (
                <div className="mx-5 my-3 px-5 py-3 rounded-xl" style={{ background: `${CH2_COLOR}10`, borderLeft: `3px solid ${CH2_COLOR}` }}>
                  <p className="text-[14px] font-bold leading-relaxed" style={{ color: CH2_COLOR, fontFamily: SERIF }}>"{partnerCallout}"</p>
                </div>
              )}
              {(partnerWonguk.intro as string | undefined) && (
                <p className="px-6 text-[14px] leading-[1.85] mb-3" style={{ color: INK, wordBreak: "keep-all" }}>{partnerWonguk.intro as string}</p>
              )}
              <div className="px-6">
            ...
            {/* 기질 카드 */}
            <section className="pb-2">
              <div className="px-6"><Heading>{partnerName}의 기질</Heading></div>
              <NatureCard data={partnerNature} color={CH2_COLOR} label={`${partnerName}을(를) 대표하는 기질`} />
            </section>

            {/* 연애 패턴 카드 */}
            <section className="pb-4">
              <div className="px-6"><Heading>{partnerName}의 연애 패턴</Heading></div>
              <LovePatternCard data={partnerLovePattern} color={CH2_COLOR} pale={CH2_PALE} />
            </section>

            {/* 홍연 마무리 인용구 */}
            <div className="mx-5 mb-6 px-5 py-4 rounded-2xl text-center" style={{ background: `linear-gradient(135deg, ${CH2_COLOR}12 0%, ${CH2_PALE} 100%)`, border: `1px solid ${CH2_COLOR}20` }}>
              <p className="text-[13px] leading-[1.8]" style={{ color: CH2_COLOR, fontFamily: SERIF }}>
                {`"${partnerName}의 사주를 살펴보았소.\n이제 두 사람 사이에 흐르는\n끌림의 기운을 들여다보겠소."`}
              </p>
            </div>
      ...
      {ch === "5" && (() => {
        ...
        const sipseongName = partnerSipseong?.sipseong ?? computedSipseong;
        ...
        return (
          <>
            ...
            <Quote>{`"이번엔 ${partnerName}의 일간으로\n나를 바라보겠소.\n${partnerName}의 눈에 내가 어떤 사람인지\n살펴보시오."`}</Quote>

            {/* 상대 기준 나의 십성 카드 */}
            {sipseongName && (
              <section className="pb-2">
                <div className="px-6"><Heading>{partnerName} 눈에 나는</Heading></div>
                <SipseongMeaningCard sipseong={sipseongName} desc={sipseongDesc} color={sipseongColor} />
              </section>
            )}

            {/* 거울 배너 — 시점 전환 시각화 */}
            <div className="mx-5 mb-5 rounded-2xl overflow-hidden" style={{ background: `linear-gradient(135deg, ${CH5_COLOR}10 0%, ${CH5_PALE} 100%)`, border: `1px solid ${CH5_COLOR}20` }}>
              <div className="flex items-center justify-between px-5 py-4">
                {/* 내 시각 (4장) */}
                <div className="flex-1 text-center">
                  <p className="text-[10px] font-bold mb-1" style={{ color: CH4_COLOR }}>4장 · 내 시각</p>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1" style={{ background: `${CH4_COLOR}18` }}>
                    <span className="text-[18px]">👁</span>
                  </div>
                  <p className="text-[11px] font-black" style={{ color: CH4_COLOR }}>{myName}</p>
                  <p className="text-[10px]" style={{ color: MUTE }}>→ {partnerName}</p>
                </div>
                {/* 중앙 */}
                <div className="px-3">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: `${CH5_COLOR}15` }}>
                    <span className="text-[16px]">🪞</span>
                  </div>
                </div>
                {/* 상대 시각 (5장) */}
                <div className="flex-1 text-center">
                  <p className="text-[10px] font-bold mb-1" style={{ color: CH5_COLOR }}>5장 · 상대 시각</p>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1" style={{ background: `${CH5_COLOR}18` }}>
                    <span className="text-[18px]">👁</span>
                  </div>
                  <p className="text-[11px] font-black" style={{ color: CH5_COLOR }}>{partnerName}</p>
                  <p className="text-[10px]" style={{ color: MUTE }}>→ {myName}</p>
                </div>
              </div>
              <div className="px-5 pb-4">
                <p className="text-[12px] text-center" style={{ color: MUTE }}>같은 두 사람을 서로 다른 눈으로 보고 있소. 이 장에서는 {partnerName}의 눈으로 나를 바라보겠소.</p>
              </div>
            </div>

            {/* 상대가 보는 나 풀이 */}
            <section className="pb-4">
              <div className="px-6"><Heading>{partnerName}의 사주로 보는 나</Heading></div>
            ...
            {partnerExpectation?.items && partnerExpectation.items.length > 0 && (
              <section className="pb-4">
                <div className="px-6"><Heading>{partnerName}이(가) 나에게 기대하는 것</Heading></div>
            ...
            {partnerWarning && (
              <section className="pb-4">
                <div className="px-6"><Heading>{partnerName}이(가) 주의할 점</Heading></div>
                <RelationWarningCard data={partnerWarning} color={CH5_COLOR} />
              </section>
            )}

            {/* 두 시각 종합 요약 배너 */}
            <div className="mx-5 mb-5 rounded-2xl px-5 py-4" style={{ background: WHITE, border: `1px solid ${INK}08`, boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
              <p className="text-[11px] font-bold mb-3 text-center" style={{ color: MUTE }}>두 시각을 종합하면</p>
              <div className="flex gap-3">
                <div className="flex-1 rounded-xl px-3 py-3" style={{ background: `${CH4_COLOR}08`, border: `1px solid ${CH4_COLOR}15` }}>
                  <p className="text-[10px] font-bold mb-1" style={{ color: CH4_COLOR }}>내가 보는 {partnerName}</p>
                  <p className="text-[11px] leading-relaxed" style={{ color: INK_SOFT }}>{(jc.myView as { intro?: string } | undefined)?.intro ?? `${partnerName}은(는) 나에게 특별한 존재이오.`}</p>
                </div>
                <div className="flex-1 rounded-xl px-3 py-3" style={{ background: `${CH5_COLOR}08`, border: `1px solid ${CH5_COLOR}15` }}>
                  <p className="text-[10px] font-bold mb-1" style={{ color: CH5_COLOR }}>{partnerName}이 보는 나</p>
                  <p className="text-[11px] leading-relaxed" style={{ color: INK_SOFT }}>{(partnerViewData as { intro?: string } | null)?.intro ?? `나는 ${partnerName}에게 특별한 존재이오.`}</p>
                </div>
              </div>
            </div>

            {/* 홍연 마무리 인용구 */}
            <div className="mx-5 mb-6 px-5 py-4 rounded-2xl text-center" style={{ background: `linear-gradient(135deg, ${CH5_COLOR}12 0%, ${CH5_PALE} 100%)`, border: `1px solid ${CH5_COLOR}20` }}>
              <p className="text-[13px] leading-[1.8]" style={{ color: CH5_COLOR, fontFamily: SERIF }}>
                {`"두 시각을 모두 살펴보았소.\n이제 두 사주 사이의\n합·충을 짚어보겠소."`}
              </p>
            </div>
      ...
      {ch === "6" && (() => {
        ...
        return (
          <>
            ...
            {/* 두 명식 관계 */}
            <section className="pb-4">
              <div className="px-6"><Heading>두 명식을 합쳐서 보면</Heading></div>
              <div className="px-6">
            ...
            {/* 종합 궁합 점수 카드 */}
            <section className="pb-4">
              <div className="px-6"><Heading>합·충 종합 점수</Heading></div>
              <HapChungScoreCard data={overallScore} hapCount={hapItems.length} chungCount={chungItems.length} />
            </section>
            ...
            {hapItems.length > 0 && (
              <section className="pb-4">
                <div className="px-6">
                  <Heading>합(合) — 두 기운이 어우러지는 곳</Heading>
                </div>
                <div className="mx-5 mb-3 px-4 py-2.5 rounded-xl" style={{ background: `${HAP_COLOR}08`, border: `1px solid ${HAP_COLOR}15` }}>
                  <p className="text-[12px] leading-relaxed" style={{ color: HAP_COLOR }}>합은 두 사주의 천간·지지가 서로 끌어당겨 합쳐지는 것이오. 합이 있는 자리에서 두 사람은 자연스럽게 통하고, 그 기운이 새로운 오행으로 변화하기도 하오.</p>
                </div>
                {hapItems.map((item, i) => <HapCard key={i} item={item} index={i} />)}
              </section>
            )}
            ...
            {chungItems.length > 0 ? (
              <section className="pb-4">
                <div className="px-6">
                  <Heading>충(沖) — 두 기운이 부딪히는 곳</Heading>
                </div>
                <div className="mx-5 mb-3 px-4 py-2.5 rounded-xl" style={{ background: `${CHUNG_COLOR}08`, border: `1px solid ${CHUNG_COLOR}15` }}>
                  <p className="text-[12px] leading-relaxed" style={{ color: CHUNG_COLOR }}>충은 두 사주의 지지가 정면으로 맞부딪히는 것이오. 갈등을 일으키기도 하지만, 서로를 자극하여 성장하게 하는 힘이기도 하오. 충을 아는 것이 관계를 지키는 첫걸음이오.</p>
                </div>
                {chungItems.map((item, i) => <ChungCard key={i} item={item} index={i} />)}
              </section>
            ) : (
              <section className="pb-4">
                <div className="px-6"><Heading>충(沖) — 두 기운이 부딪히는 곳</Heading></div>
                <div className="mx-5 mb-3 px-5 py-4 rounded-2xl" style={{ background: `${HAP_COLOR}06`, border: `1px solid ${HAP_COLOR}15` }}>
                  <p className="text-[13px] leading-relaxed" style={{ color: HAP_COLOR }}>두 사람의 사주에서 충(沖)이 발견되지 않았소. 이는 두 기운이 직접적으로 충돌하는 자리가 없다는 것이오. 서로 기운이 덜 부딪히니, 관계에서 큰 마찰 없이 흘러가는 편이오.</p>
                </div>
              </section>
            )}

            {/* 홍연 마무리 인용구 */}
            <div className="mx-5 mb-6 px-5 py-4 rounded-2xl text-center" style={{ background: `linear-gradient(135deg, ${CH6_COLOR}12 0%, ${CH6_PALE} 100%)`, border: `1px solid ${CH6_COLOR}20` }}>
              <p className="text-[13px] leading-[1.8]" style={{ color: CH6_COLOR, fontFamily: SERIF }}>
                {"합·충을 파악했으니,\n이제 연애 스타일이\n얼마나 맞는지 살펴보겠소."}
              </p>
            </div>
      ...
      {ch === "9" && (() => {
        ...
        return (
          <>
            ...
            {/* 위기 총평 — crisisSummary */}
            {crisisData?.crisisSummary && (
              <div className="mx-5 mb-5 rounded-xl px-4 py-3.5" style={{ background: `${CH9_COLOR}08`, border: `1px solid ${CH9_COLOR}22`, borderLeft: `3px solid ${CH9_COLOR}` }}>
                <p className="text-[13.5px] leading-[1.85]" style={{ color: INK, wordBreak: "keep-all", fontFamily: SERIF }}>{crisisData.crisisSummary}</p>
              </div>
            )}
            ...
            {crisisItems.length > 0 && (
              <section className="px-5 pt-2 pb-2">
                ...
                <p className="text-[13px] leading-[1.85] mb-5" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>
            ...
            {flowItems.length > 0 && (
              <section className="pt-2 pb-4">
                ...
                {flowData?.overviewDesc && (
                  <div className="mx-5 mb-5 rounded-xl px-4 py-3.5" style={{ background: CALLOUT_BG, borderLeft: `3px solid ${CH9_COLOR}` }}>
                    <p className="text-[13.5px] leading-[1.85]" style={{ color: INK, wordBreak: "keep-all", fontFamily: SERIF }}>{flowData.overviewDesc}</p>
                  </div>
                )}
      ...
      {ch === "10" && (() => {
        ...
        const mpScore  = (mpData?.score as number | undefined) ?? 78;
        const mpLabel  = (mpData?.label as string | undefined) ?? "결혼까지 충분히 이어질 수 있는 궁합이오";
        ...
        return (
          <>
            ...
            <Quote>{`"많은 분들이 가장 궁금해하시오.\n이 사람과 결혼할 수 있을지,\n홍연이 솔직하게 말씀드리겠소."`}</Quote>

            {/* 결혼 가능성 게이지 */}
            <section className="px-5 pt-2 pb-4">
              <Heading>결혼 가능성 지수</Heading>
              <p className="text-[13px] leading-[1.85] mb-5" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>
                결혼 가능성은 단순한 궁합 점수가 아니오. 두 사람의 일간·십성·오행이 서로 어떤 관계를 맺고 있는지, 관성·재성·인성의 흐름이 어떻게 맞물리는지를 종합한 결과이오. 숫자 하나로 인연의 무게를 다 담을 수는 없지만, 방향을 가리키는 나침반으로 활용하시오.
              </p>
              <MarriageGauge score={mpScore} label={mpLabel} />
              {/* 사주 판단 근거 */}
              {mpBasis && (
                <div className="mt-4 rounded-xl px-4 py-3.5" style={{ background: CH10_PALE, borderLeft: `3px solid ${CH10_COLOR}` }}>
                  <p className="text-[13px] leading-[1.85]" style={{ color: INK, wordBreak: "keep-all", fontFamily: SERIF }}>{mpBasis}</p>
                </div>
              )}
              {/* 4단락 풀이 */}
              {mpParas.length > 0 && (
                <div className="mt-5">
                  {mpParas.map((p, i) => (
                    <p key={i} className="text-[14px] leading-[1.9] mb-4" style={{ color: INK, wordBreak: "keep-all" }}>{p}</p>
                  ))}
                </div>
              )}
            </section>
            ...
            {/* 구분선 */}
            <div className="mx-5 my-3" style={{ borderTop: `1px dashed ${CH10_COLOR}20` }} />

            {/* 결혼의 조건 */}
            {condItems.length > 0 && (
              <section className="px-5 pt-2 pb-2">
                <Heading>결혼으로 이어지는 조건</Heading>
                <p className="text-[13px] leading-[1.85] mb-5" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>
                  사주에서 결혼은 '운명'이 아니라 '조건'이오. 두 사람의 기운이 아무리 잘 맞아도, 함께 갖추어야 할 것들이 있소. 이 조건들이 충족될 때 비로소 인연이 결혼으로 무르익소. 어떤 조건이 이 관계에 놓여 있는지 찬찬히 살펴보시오.
                </p>
                {condItems.map((item, i) => (
                  <MarriageConditionCard key={i} item={item} index={i} />
                ))}
              </section>
            )}
      ...
      {/* ═══════════ 제11장 · 두 사람이 함께하면 좋은 시기 ═══════════ */}
      {ch === "11" && (() => {
        type GoodItem    = { label: string; icon?: string; desc?: string; activity?: string; sajuBasis?: string };
        type CautionItem = { label: string; icon?: string; desc?: string; cope?: string };
        const gpData  = (jc.goodPeriods    as { items?: GoodItem[] }    | undefined) ?? null;
        const cpData  = (jc.cautionPeriods as { items?: CautionItem[] } | undefined) ?? null;
        const yfData  = (jc.yearlyFlow     as Record<string, unknown>   | undefined) ?? null;
        const goodItems    = gpData?.items ?? [];
        const cautionItems = cpData?.items ?? [];
        return (
          <>
            {/* 헤더 */}
            <div className="text-center px-6 py-4" style={{ background: "#111" }}>
              <p className="text-[10px] tracking-[0.25em] mb-2" style={{ color: "rgba(255,255,255,0.5)", fontFamily: SERIF }}>제 11 장 · 좋은 시기</p>
              <h1 className="text-[20px] font-black leading-snug" style={{ color: "#fff", fontFamily: SERIF }}>두 사람이 함께하면 좋은 시기</h1>
            </div>
            {/* 커버 이미지 */}
            <div className="relative overflow-hidden" style={{ height: 360 }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_yeonae/kunghap_yeonae_11/kunghap_yeonae_11_cover.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition: "center 30%" }} />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(17,17,17,1) 0%, rgba(17,17,17,0.3) 35%, transparent 60%, transparent 70%, rgba(238,247,242,1) 100%)" }} />
            </div>
            ...
            {goodItems.length > 0 && (
              <section className="px-5 pt-2 pb-2">
                <Heading>함께하면 좋은 시기</Heading>
                <p className="text-[13px] leading-[1.85] mb-5" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>
                  사주명리에서 '좋은 시기'란 단순히 운이 트이는 때가 아니오. 두 사람의 기운이 서로를 끌어올리고, 대운과 세운이 함께 관계를 밀어주는 시절이오. 이 시기에 더 많은 것을 나누고, 더 깊은 약속을 나누면 오래 기억될 인연의 무늬가 새겨질 것이오.
                </p>
                {goodItems.map((item, i) => (
                  <GoodPeriodCard key={i} item={item} index={i} />
                ))}
              </section>
            )}

            {/* 구분선 */}
            <div className="mx-5 my-4" style={{ borderTop: `1px dashed ${CH11_COLOR}25` }} />

            {/* 조심할 시기 */}
            {cautionItems.length > 0 && (
              <section className="px-5 pt-2 pb-2">
                <Heading>조심해야 할 시기</Heading>
                <p className="text-[13px] leading-[1.85] mb-5" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>
                  봄날이 있다면 장마도 있는 법이오. 이 시기에 두 사람의 기운이 서로 어긋나거나, 외부의 기운이 관계를 흔들 수 있소. 위기가 찾아오기 전에 미리 알고 준비한 사람은 무너지지 않소. 이 시기를 조심하고, 더 많이 대화하며 서로를 붙들어 주시오.
                </p>
                {cautionItems.map((item, i) => (
                  <CautionPeriodCard key={i} item={item} index={i} />
                ))}
              </section>
            )}
            ...
            {yfData && (
              <section className="px-5 pt-2 pb-4">
                <Heading>두 사람의 시간을 대하는 자세</Heading>
                <p className="text-[13px] leading-[1.85] mb-5" style={{ color: INK_SOFT, wordBreak: "keep-all" }}>
                  봄날과 장마를 모두 알았으니, 이제 두 사람이 함께 이 시간들을 어떻게 헤쳐나갈지가 남았소. 좋은 시기에 더 단단해지고, 어려운 시기에 더 따뜻해지는 것이 오래 함께하는 인연의 비결이오.
                </p>
                <YearlyFlowSummary data={yfData} />
              </section>
            )}
