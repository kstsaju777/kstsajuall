...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/kunghap_yeonae/report-preview?${reportParams.toString()}`;
    router.push(`/saju/kunghap_yeonae/report-preview?${reportParams.toString()}`);
    if (email) {
      try {
