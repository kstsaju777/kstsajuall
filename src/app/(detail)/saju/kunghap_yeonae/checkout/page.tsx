  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="relative">
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "19.15%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람 각자의</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>연애성향이 어떤지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "28.1%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>어떤 성향의 이성이</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>각자 사주에 잘 맞는지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "34.3%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람이 처음 만났을 때</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>첫느낌이 어땠었는지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "43.1%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "56.45%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>향후 10년간 두사람</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>인연흐름을 그래프로 보여주오.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "67.35%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람이 결혼을 하게된다면</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>언제가 가장 좋을지도 말해주오.</p>
        </div>
        <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "82.3%", left: "33%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "91.6%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람 사주에</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>좋거나 나쁘거나 위기의 흐름까지</p>
        </div>
  ...
  return (
    <div className="fixed bottom-0 flex items-center gap-3 px-4 z-50"
      ...
      <button onClick={onPay}
        ...
        style={{ animation: "yeonaeBtnNeon 3s ease-in-out infinite, yeonaeBtnBeat 2s ease-in-out infinite" }}>
        연애궁합 확인하기
      </button>
    </div>
  );
...
const CHAPTER_TITLES = [
  "제1장 — 나의 원국", "제2장 — 상대 원국", "제3장 — 끌림",
  "제4장 — 내 시각", "제5장 — 상대 시각", "제6장 — 합·충",
  "제7장 — 연애 스타일", "제8장 — 빛과 그림자", "제9장 — 위기와 극복",
  "제10장 — 결혼", "제11장 — 좋은 시기", "마무리 — 홍연의 서신",
];
const TOTAL = 12;
...
const PRODUCT_INFO = { name: "연애궁합", price: 29900 };
...
function CheckoutContent() {
  ...
  const buildOrderBody = useCallback(() => {
    ...
    return { productSlug: PRODUCT_SLUG, email: email || "", name, birthDate, birthTime, timeUnknown, gender: genderApi, calendar: calApi, concerns: concern ? [concern] : [], phone: phone || undefined, partnerName, partnerBirthDate, partnerBirthTime, partnerTimeUnknown, partnerGender: partnerGenderApi, partnerCalendar: partnerCalApi, concern };
  ...
  return (
    <div className="w-full h-full" style={{ backgroundColor: WHITE }}>
      <div className="w-full h-full overflow-y-auto" style={{ scrollbarWidth: "none", paddingBottom: 80 }}>
        ...
        {/* ① 상단 이미지 */}
        <div className="relative">
          <img src="/media/checkout/kunghap_yeonae/s1.jpg" alt="" className="w-full block" />
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "54.8%", left: "42%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>두 사람 연애궁합을 보기 전에 </p>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님`}의 사주팔자가</p>
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "95.5%", left: "60%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            ...
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님`}의</p>
          ...
          <div className="fixed bottom-0 z-[60] rounded-t-3xl overflow-hidden"
            ...
            <div className="toss-widget-wrap">
              <TossWidget
                ...
                successUrl={`${typeof window !== 'undefined' ? window.location.origin : 'https://www.hongyeondang.com'}/saju/kunghap_yeonae/checkout/success`}
