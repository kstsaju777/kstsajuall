...
function FormShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      {/* 배경 이미지 — 전체 화면 */}
      <img
        src="/media/cards/kunghap_yeonae/yeonae-0.jpg"
        aria-hidden
...
function StepIntro({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center" style={{ minHeight: "100dvh", backgroundColor: "#0a0c10" }}>
      <img src="/media/cards/kunghap_yeonae/yeonae-0.jpg" className="absolute inset-0 w-full h-full object-cover object-top opacity-30" />
...
function YeonaeEmailIntro({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center" style={{ minHeight: "100dvh", backgroundColor: "#0a0c10" }}>
      <img src="/media/cards/kunghap_yeonae/yeonae-0.jpg" className="absolute inset-0 w-full h-full object-cover object-top opacity-30" alt="" />
      <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(10,12,16,0.3) 0%, rgba(10,12,16,0.7) 60%, rgba(10,12,16,1) 100%)" }} />
      <div className="relative z-10 px-8 text-center">
        <p className="text-[26px] font-bold leading-relaxed whitespace-pre-line" style={{ color: "#fff", minHeight: "2.2em" }}>
          {displayed}
...
function StepLoading({ name, date, time, calendar, gender, email, phone, partnerName, partnerDate, partnerTime, partnerCalendar, partnerGender, concern }: {
  ...
  const goNext = () => {
    ...
    router.push(`/saju/kunghap_yeonae/checkout?${params.toString()}`);
  };
  ...
  return (
    <div className="relative flex flex-col items-center justify-center" style={{ minHeight: "100dvh", backgroundColor: "#080a0f" }}>
      <img src="/media/cards/kunghap_yeonae/yeonae-0.jpg" className="absolute inset-0 w-full h-full object-cover object-top opacity-20" alt="" />
      ...
      <div className="relative z-10 px-8 w-full max-w-sm text-center">
        ...
        <p className="text-[13px] mb-8" style={{ color: "rgba(255,255,255,0.5)" }}>홍연이 두 사람의 연애 궁합을 살펴보고 있어요</p>
