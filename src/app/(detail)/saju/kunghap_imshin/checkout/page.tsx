...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/kunghap_imshin/report-preview?${reportParams.toString()}`;
    router.push(`/saju/kunghap_imshin/report-preview?${reportParams.toString()}`);
    setShowSheet(false);
    if (email) {
