...
const WHITE    = "#ffffff";
const RED      = "#738e6f";
const RED_SOFT = "#92a88e";
const RED_PALE = "#f0f4ef";
const ROSE     = "#b8ccb5";
const GRAY1    = "#1a1a1a";
const GRAY2    = "#444444";
const GRAY3    = "#888888";
  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="relative">
        ...
        <img src="/media/checkout/kunghap_imshin/s2.jpg" alt="" className="w-full block" />
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "18.9%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님이`}</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>어떤 부모가 될지도 보이는군.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "26.4%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두사람 첫 아이의 성별까지</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>사주로 미리 짚어보겠소.</p>
        </div>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "47.55%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>자녀운이 강해지는 시기까지</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>하나하나 살펴보겠소.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "59.0%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>임신과 출산 시기에</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>주의할 건강까지 알려주겠소.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "67.7%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>언제가 길하고 언제 주의할지,</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>10년치를 한눈에 짚어드리겠소.</p>
        </div>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "91.63%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>아이를 기르는 동안</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>고비가 될 시기까지 짚어드리오.</p>
        </div>
...
const FAQS = [
  ...
  { q: "어떤 항목을 분석하나요?", a: "두 사람의 임신 인연, 임신 가능 시기, 자녀 인연과 자녀 복, 임신에 유리한 운의 흐름, 임신을 방해하는 요인 등 총 14장에 걸쳐 상세히 풀이하오." },
];
...
// ─── 결제 모달 ────────────────────────────────────────────────────────────────
const PRODUCT = { name: "임신궁합", original: 49800, discount: 40, price: 29900 };
      ...
      <div className="fixed bottom-0 z-50 overflow-y-auto rounded-t-3xl"
        ...
        <div className="px-5 pt-2 pb-7">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-[18px] font-black" style={{ color: DTXT }}>임신궁합 결제 안내</h3>
          ...
          <div className="inline-block text-[13px] font-bold px-3.5 py-1.5 rounded-full mb-5"
            style={{ background: "rgba(115,142,111,0.16)", border: `1px solid ${ACCENT}55`, color: "#92a88e" }}>
            총 <span style={{ color: "#738e6f" }}>{saved.toLocaleString()}원</span> 할인받았어요!
          </div>
          <div className="mb-5">
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="text-right flex-shrink-0">
                  <p className="text-[11px]" style={{ color: DSTRIKE }}>
                    <span style={{ color: "#738e6f", fontWeight: 700 }}>{PRODUCT.discount}%</span>{" "}
          ...
          <div className="space-y-1.5 mb-4">
            ...
            <div className="flex items-center justify-between text-[13px]">
              <span style={{ color: "#738e6f", fontWeight: 700 }}>지금 결제 시 할인 ({PRODUCT.discount}% 특가)</span>
              <span style={{ color: "#738e6f", fontWeight: 700 }}>-{saved.toLocaleString()}</span>
            </div>
          </div>
          <button onClick={onConfirm}
            className="w-full py-4 rounded-2xl font-black text-[17px] text-white active:scale-[0.99] transition-transform"
            style={{ background: "linear-gradient(135deg, #92a88e, #738e6f)", boxShadow: "0 6px 20px rgba(115,142,111,0.4)" }}>
            결제하기
          </button>
        ...
        <div className="fixed z-[60] px-6"
          ...
          <div className="relative mx-auto rounded-2xl px-5 py-4"
            ...
            <button onClick={() => setConfirmExit(false)}
              ...
              style={{ background: "linear-gradient(135deg, #92a88e, #738e6f)" }}>혜택 받고 계속하기</button>
...
const TIME_COLORS: Record<string, string> = {
  "방금": "#738e6f", "방금 전": "#738e6f",
  "1분 전": "#5a7056", "2분 전": "#5a7056",
      ...
      <div style={{ position: "fixed", bottom: 100, right: "max(8px, calc(50vw - 232px))", zIndex: 49, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, pointerEvents: "none" }}>
        {toasts.map((t) => (
          <div key={t.id} style={{ animation: "toastInRight 0.35s ease", display: "flex", alignItems: "center", gap: 6, backgroundColor: "rgba(0,0,0,0.7)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 9999, padding: "6px 14px", fontSize: 12, color: "#fff", whiteSpace: "nowrap", backdropFilter: "blur(6px)" }}>
            <span style={{ backgroundColor: TIME_COLORS[t.time] ?? "#5a7056", color: "#fff", fontSize: 10, fontWeight: 700, borderRadius: 9999, padding: "2px 7px" }}>{t.time}</span>
...
function StickyPayCTA({ onPay }: { onPay: () => void; name: string; partnerName: string }) {
  ...
  return (
    <div className="fixed bottom-0 flex items-center gap-3 px-4 z-50"
      ...
      <style>{`
        @keyframes imshinBtnNeon {
          0%   { background: #738e6f; box-shadow: 0 0 12px 3px rgba(115,142,111,0.7); }
          33%  { background: #5a7056; box-shadow: 0 0 12px 3px rgba(90,112,86,0.7); }
          66%  { background: #92a88e; box-shadow: 0 0 12px 3px rgba(146,168,142,0.7); }
          100% { background: #738e6f; box-shadow: 0 0 12px 3px rgba(115,142,111,0.7); }
        }
        @keyframes imshinBtnBeat {
      ...
      <button onClick={onPay}
        ...
        style={{ animation: "imshinBtnNeon 3s ease-in-out infinite, imshinBtnBeat 2s ease-in-out infinite" }}>
        임신궁합 확인하기
      </button>
    </div>
  );
...
const CHAPTER_TITLES = [
  "제1장 — 나의 원국", "제2장 — 배우자 원국", "제3장 — 임신 궁합",
  "제4장 — 자녀 기운", "제5장 — 임신 시기", "제6장 — 합·충",
  "제7장 — 건강·관리", "제8장 — 감정 유대", "제9장 — 어려움",
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 px-8"
      ...
      <style>{`
        ...
        @keyframes glow-pulse { 0%,100%{box-shadow:0 0 8px 2px #738e6faa,0 0 20px 4px #4a6a4555} 50%{box-shadow:0 0 16px 4px #8faa8bcc,0 0 40px 10px #738e6f88} }
      ...
      <div className="relative w-20 h-20 mb-6">
        ...
        {[0,1,2,3,4,5].map(i => (
          <div key={i} className="absolute w-1 h-1 rounded-full" style={{
            ...
            background: i % 2 === 0 ? "#8faa8b" : "#b5ccb2",
            boxShadow: `0 0 6px 2px ${i % 2 === 0 ? "#738e6f" : "#9ab897"}`,
            animation: `orbit ${2.5 + i * 0.4}s linear infinite`,
            animationDelay: `${i * -0.5}s`,
          }} />
        ))}
        <div className="absolute inset-0 flex items-center justify-center">
          <span style={{ fontSize: 28, filter: "drop-shadow(0 0 8px #738e6f)" }}>✦</span>
        </div>
      </div>
      <p className="text-[18px] font-bold mb-1" style={{ color: "#fff5ee", fontFamily: "'Noto Serif KR', serif", textShadow: "0 0 20px #738e6f88" }}>
        결과지를 완성하고 있소…
      </p>
      <p key={currentChapter} className="text-[13px] mb-8" style={{ color: "#9ab897", animation: "title-fade 4s ease-in-out", minHeight: 20 }}>
        {doneCount < TOTAL ? CHAPTER_TITLES[currentChapter - 1] + " 풀이 중" : "마무리 중이오…"}
      </p>
      <div className="w-full max-w-[280px] mb-3">
        <div className="flex justify-between text-[11px] mb-2" style={{ color: "#4f7060" }}>
          <span>{doneCount} / {TOTAL} 장 완성</span>
          <span>{pct}%</span>
        </div>
        <div className="w-full h-3 rounded-full overflow-hidden relative" style={{ background: "#0a1009" }}>
          <div className="h-full rounded-full relative overflow-hidden transition-all duration-700"
            style={{ width: `${pct}%`, background: "linear-gradient(90deg, #2a4028, #738e6f, #9ab897)", animation: pct > 0 ? "glow-pulse 1.8s ease-in-out infinite" : "none" }}>
      ...
      <p className="text-[11px] text-center leading-relaxed mt-4" style={{ color: "#3a5538" }}>
...
const PRODUCT_INFO = { name: "임신궁합", price: 29900 };
  ...
  return (
    <div className="w-full h-full" style={{ backgroundColor: WHITE }}>
      <div className="w-full h-full overflow-y-auto" style={{ scrollbarWidth: "none", paddingBottom: 80 }}>
        ...
        {/* ① 상단 이미지 */}
        <div className="relative">
          <img src="/media/checkout/kunghap_imshin/s1.jpg" alt="" className="w-full block" />
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "54.8%", left: "42%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>두 사람 임신궁합을 보기 전에</p>
        ...
        {/* ③ 하단 이미지 */}
        <div className="relative">
          <img src="/media/checkout/kunghap_imshin/s3.jpg" alt="" className="w-full block" />
          <div className="absolute bottom-0 left-0 right-0 h-16 pointer-events-none" style={{ background: `linear-gradient(to bottom, transparent, ${WHITE})` }} />
          <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "2.6%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
            <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두사람 임신운에 대해</p>
          ...
          <div className="fixed bottom-0 z-[60] rounded-t-3xl overflow-hidden"
            ...
            <div className="toss-widget-wrap">
              <TossWidget
                ...
                successUrl={`${typeof window !== 'undefined' ? window.location.origin : 'https://www.hongyeondang.com'}/saju/kunghap_imshin/checkout/success`}
...
export default function KunghapImshinCheckoutPage() {
  return (
    <Suspense fallback={
