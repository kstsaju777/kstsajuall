...
const IMG_BG     = "/media/cards/kunghap_imshin/imshin-0.jpg";
...
function StepIntro({ scenes, onNext }: { scenes: string[]; onNext: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center" style={{ backgroundColor: CARD_BG }}>
  ...
  return (
    <>
      <div className="px-6 pt-4 pb-3" style={{ backgroundColor: CARD_BG }}>
        ...
        <p className="text-right text-[11px] mt-1 pr-1" style={{ color: "rgba(115,142,111,0.7)" }}>{text.length}/{MAX}</p>
      </div>
...
function StepLoading({ name, date, time, calendar, gender, email, concern,
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center" style={{ backgroundColor: "#080c0a" }}>
