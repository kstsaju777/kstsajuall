...
//
// 미리보기: http://localhost:3000/saju/kunghap_business/report-preview
//
...
const BCH8_LIGHT  = "#b07d2a"; // 황금 (빛)
const BCH8_SHADOW = "#4a5568"; // 슬레이트 (그림자)
...
function ReviewBox() {
  ...
  return (
    <div className="rounded-2xl p-5 mx-6 mb-8" style={{ background: WHITE, border: "1.5px solid #4e9eff", boxShadow: "0 0 6px #4e9eff80, 0 0 16px #4e9eff40, 0 0 32px #4e9eff20" }}>
...
function isYeonaeChapterReady(content: Record<string, unknown> | null | undefined, chapter: number): boolean {
  return isBusinessKunghapChapterReady(content, chapter);
}
        ...
        <div className="px-5 py-6">
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[15px]" style={{ color: MUTE }}>[비즈니스궁합]</span>
            </div>
            <button
              onClick={onClose}
...
const CROSS_DESC_BIZ: Record<string, string> = {
  ...
  "천간합_을경": "을목(乙)과 경금(庚)이 만나 금(金)으로 합화되오. 을목의 부드럽고 유연한 감수성이 경금의 날카롭고 결단력 있는 기운과 만나 정밀하고 세련된 에너지로 변화하오. 두 사람은 서로의 성격이 꽤 달라 보이지만, 오히려 그 차이가 맞물려 함께 있을 때 완성도 높은 결과물을 만들어내오. 비즈니스 협업에서 서로의 역할이 자연스럽게 분담되오.",
  "천간합_경을": "을목(乙)과 경금(庚)이 만나 금(金)으로 합화되오. 을목의 부드럽고 유연한 감수성이 경금의 날카롭고 결단력 있는 기운과 만나 정밀하고 세련된 에너지로 변화하오. 두 사람은 서로의 성격이 꽤 달라 보이지만, 오히려 그 차이가 맞물려 함께 있을 때 완성도 높은 결과물을 만들어내오. 비즈니스 협업에서 서로의 역할이 자연스럽게 분담되오.",
  "천간합_병신": "병화(丙)와 신금(辛)이 만나 수(水)로 합화되오. 병화의 뜨겁고 개방적인 에너지와 신금의 섬세하고 내밀한 기운이 만나, 깊이 있는 감성과 직관의 수 기운으로 변화하오. 겉으로는 전혀 달라 보이는 두 사람이지만, 함께 있을 때 서로의 내면을 꺼내놓게 만드는 묘한 끌림이 있소. 협업 과정에서 서로를 깊이 이해하는 힘이 되오.",
  "천간합_신병": "병화(丙)와 신금(辛)이 만나 수(水)로 합화되오. 병화의 뜨겁고 개방적인 에너지와 신금의 섬세하고 내밀한 기운이 만나, 깊이 있는 감성과 직관의 수 기운으로 변화하오. 겉으로는 전혀 달라 보이는 두 사람이지만, 함께 있을 때 서로의 내면을 꺼내놓게 만드는 묘한 끌림이 있소. 협업 과정에서 서로를 깊이 이해하는 힘이 되오.",
  "천간합_정임": "정화(丁)와 임수(壬)가 만나 목(木)으로 합화되오. 정화의 따뜻하고 섬세한 감성과 임수의 넓고 포용력 있는 기운이 합쳐져, 새로운 생명력과 성장의 목 기운으로 변화하오. 두 사람이 함께하면 서로를 향한 진심 어린 배려가 자연스럽게 흘러나오고, 비즈니스 파트너십이 깊어지오.",
  "천간합_임정": "정화(丁)와 임수(壬)가 만나 목(木)으로 합화되오. 정화의 따뜻하고 섬세한 감성과 임수의 넓고 포용력 있는 기운이 합쳐져, 새로운 생명력과 성장의 목 기운으로 변화하오. 두 사람이 함께하면 서로를 향한 진심 어린 배려가 자연스럽게 흘러나오고, 비즈니스 파트너십이 깊어지오.",
  "천간합_무계": "무토(戊)와 계수(癸)가 만나 화(火)로 합화되오. 무토의 묵직하고 넓은 대지 기운과 계수의 섬세하고 맑은 물 기운이 합쳐지면 강렬한 화 기운이 생겨나오. 두 사람 사이에 열정과 추진력의 불꽃이 쉽게 일어나며, 함께 있을 때 생명력 넘치는 에너지가 흐르오. 비즈니스 목표를 향한 두 사람의 의지가 하나로 모이는 구조이오.",
  "천간합_계무": "무토(戊)와 계수(癸)가 만나 화(火)로 합화되오. 무토의 묵직하고 넓은 대지 기운과 계수의 섬세하고 맑은 물 기운이 합쳐지면 강렬한 화 기운이 생겨나오. 두 사람 사이에 열정과 추진력의 불꽃이 쉽게 일어나며, 함께 있을 때 생명력 넘치는 에너지가 흐르오. 비즈니스 목표를 향한 두 사람의 의지가 하나로 모이는 구조이오.",
  "천간충_갑경": "갑목(甲)과 경금(庚)의 충이오. 목이 성장하고 뻗어나가려는 기운과 금이 자르고 제한하는 기운이 정면으로 맞부딪히는 구조이오. 협업 과정에서 한 사람이 빠르게 나아가려 할 때 다른 사람이 신중하게 제동을 거는 패턴이 생길 수 있소. 갑목의 방향성과 경금의 판단력이 협력으로 전환되면 오히려 든든한 비즈니스 팀이 되오.",
  "천간충_경갑": "갑목(甲)과 경금(庚)의 충이오. 목이 성장하고 뻗어나가려는 기운과 금이 자르고 제한하는 기운이 정면으로 맞부딪히는 구조이오. 협업 과정에서 한 사람이 빠르게 나아가려 할 때 다른 사람이 신중하게 제동을 거는 패턴이 생길 수 있소. 갑목의 방향성과 경금의 판단력이 협력으로 전환되면 오히려 든든한 비즈니스 팀이 되오.",
  "천간충_을신": "을목(乙)과 신금(辛)의 충이오. 을목의 유연하고 섬세한 기운이 신금의 날카롭고 원칙적인 기운과 충돌하오. 협업 방식이 다를 때 쉽게 부딪힐 수 있으니, 상대방의 스타일을 인정하는 것이 이 충을 다스리는 핵심이오.",
  "천간충_신을": "을목(乙)과 신금(辛)의 충이오. 을목의 유연하고 섬세한 기운이 신금의 날카롭고 원칙적인 기운과 충돌하오. 협업 방식이 다를 때 쉽게 부딪힐 수 있으니, 상대방의 스타일을 인정하는 것이 이 충을 다스리는 핵심이오.",
  "천간충_병임": "병화(丙)와 임수(壬)의 충이오. 불과 물이 정면으로 부딪히는 가장 극적인 천간충 중 하나이오. 한 사람은 감정을 바로 표현해야 하고, 다른 사람은 충분히 생각하고 정리한 뒤에 말하는 스타일이어서 의사결정 템포가 자주 어긋날 수 있소.",
  "천간충_임병": "병화(丙)와 임수(壬)의 충이오. 불과 물이 정면으로 부딪히는 가장 극적인 천간충 중 하나이오. 한 사람은 감정을 바로 표현해야 하고, 다른 사람은 충분히 생각하고 정리한 뒤에 말하는 스타일이어서 의사결정 템포가 자주 어긋날 수 있소.",
  ...
  "천간충_무임": "무토(戊)와 임수(壬)의 충이오. 안정을 원하는 기운과 변화를 원하는 기운이 충돌하오. 비즈니스 방향을 둘러싼 결정에서 의견 차이가 생기기 쉬우니, 각자의 필요를 존중하며 조율하는 것이 열쇠이오.",
  "천간충_임무": "무토(戊)와 임수(壬)의 충이오. 안정을 원하는 기운과 변화를 원하는 기운이 충돌하오. 비즈니스 방향을 둘러싼 결정에서 의견 차이가 생기기 쉬우니, 각자의 필요를 존중하며 조율하는 것이 열쇠이오.",
  "육합_자축": "자(子)와 축(丑)이 만나 토(土)로 합화되오. 가까이 있으면 자연스럽게 서로를 의지하게 되오. 화려하게 드러나는 합은 아니지만, 오래 함께할수록 더욱 깊어지는 조용한 신뢰의 관계이오. 비즈니스를 함께 키워나가기에 든든한 기운이오.",
  "육합_축자": "자(子)와 축(丑)이 만나 토(土)로 합화되오. 가까이 있으면 자연스럽게 서로를 의지하게 되오. 화려하게 드러나는 합은 아니지만, 오래 함께할수록 더욱 깊어지는 조용한 신뢰의 관계이오. 비즈니스를 함께 키워나가기에 든든한 기운이오.",
  "육합_인해": "인(寅)과 해(亥)가 만나 목(木)으로 합화되오. 두 사람이 함께하면 서로를 성장시키는 에너지가 강하게 흐르오. 새로운 사업을 시작하는 준비에서 강한 시너지를 발휘하는 조합이오.",
  "육합_해인": "인(寅)과 해(亥)가 만나 목(木)으로 합화되오. 두 사람이 함께하면 서로를 성장시키는 에너지가 강하게 흐르오. 새로운 사업을 시작하는 준비에서 강한 시너지를 발휘하는 조합이오.",
  "육합_묘술": "묘(卯)와 술(戌)이 만나 화(火)로 합화되오. 두 사람 사이에 감정적인 연결이 강하고, 함께 있으면 서로에 대한 신뢰가 더욱 뜨겁게 달아오르는 경향이 있소. 비즈니스를 향한 두 사람의 열정이 하나로 모이는 자리이오.",
  "육합_술묘": "묘(卯)와 술(戌)이 만나 화(火)로 합화되오. 두 사람 사이에 감정적인 연결이 강하고, 함께 있으면 서로에 대한 신뢰가 더욱 뜨겁게 달아오르는 경향이 있소. 비즈니스를 향한 두 사람의 열정이 하나로 모이는 자리이오.",
  "육합_진유": "진(辰)과 유(酉)가 만나 금(金)으로 합화되오. 두 사람이 함께하면 서로의 장점이 더욱 선명하게 빛나고, 상대방을 통해 자신의 잠재력을 발견하게 되는 경우가 많소. 안정적인 사업 기반을 다지기에 좋은 기운이오.",
  "육합_유진": "진(辰)과 유(酉)가 만나 금(金)으로 합화되오. 두 사람이 함께하면 서로의 장점이 더욱 선명하게 빛나고, 상대방을 통해 자신의 잠재력을 발견하게 되는 경우가 많소. 안정적인 사업 기반을 다지기에 좋은 기운이오.",
  "육합_사신": "사(巳)와 신(申)이 만나 수(水)로 합화되오. 두 사람 사이에 서로를 날카롭게 파악하는 통찰이 오가고, 협업 과정에서 깊이 있는 대화가 자연스럽게 이어지는 관계이오.",
  "육합_신사": "사(巳)와 신(申)이 만나 수(Water)로 합화되오. 두 사람 사이에 서로를 날카롭게 파악하는 통찰이 오가고, 협업 과정에서 깊이 있는 대화가 자연스럽게 이어지는 관계이오.",
  "육합_오미": "오(午)와 미(未)가 만나 화(Fire)로 합화되오. 두 사람이 함께하면 분위기가 밝고 따뜻해지며, 서로에 대한 호감과 신뢰 표현이 자연스럽게 흘러나오오. 협업 과정에서 서로를 격려하는 온기가 넘치는 조합이오.",
  "육합_미오": "오(午)와 미(未)가 만나 화(Fire)로 합화되오. 두 사람이 함께하면 분위기가 밝고 따뜻해지며, 서로에 대한 호감과 신뢰 표현이 자연스럽게 흘러나오오. 협업 과정에서 서로를 격려하는 온기가 넘치는 조합이오.",
  "삼합_인오술": "인(寅)·오(午)·술(戌)이 모여 화국(火局)을 이루오. 함께하면 열정과 추진력이 두드러지며, 사업을 함께 이끌어나가는 과정에서 강한 활력을 발휘하는 조합이오.",
  "삼합_신자진": "신(申)·자(子)·진(辰)이 모여 수국(水局)을 이루오. 함께하면 서로를 깊이 이해하는 대화가 자연스럽게 이루어지며, 협업 과정에서 감정적 교류가 풍부한 관계가 되오.",
  "삼합_해묘미": "해(亥)·묘(卯)·미(未)가 모여 목국(木局)을 이루오. 함께하면 새로운 사업을 향한 성장 에너지가 강하게 흐르오. 새로운 일을 시작하고 키워나가는 데 특히 좋은 기운이오.",
  "삼합_사유축": "사(巳)·유(酉)·축(丑)이 모여 금국(金局)을 이루오. 함께하면 서로에게 엄격한 기준을 요구하게 되기도 하지만, 두 사람이 함께 이루어내는 결과물의 완성도가 높아지오.",
  "충_자오": "자(子)와 오(午)가 충하오. 한 사람은 감정을 충분히 삭힌 뒤 말하고 싶고, 다른 사람은 즉각적으로 표현하고 반응받고 싶어하는 구조가 충돌을 만들어내오. 비즈니스를 둘러싼 감정 표현 방식의 차이에서 갈등이 생길 수 있소.",
  "충_오자": "자(子)와 오(午)가 충하오. 한 사람은 감정을 충분히 삭힌 뒤 말하고 싶고, 다른 사람은 즉각적으로 표현하고 반응받고 싶어하는 구조가 충돌을 만들어내오. 비즈니스를 둘러싼 감정 표현 방식의 차이에서 갈등이 생길 수 있소.",
  ...
  "충_인신": "인(寅)과 신(申)이 충하오. 한 사람은 직관적으로 빠르게 움직이려 하고, 다른 사람은 논리적으로 따져보고 결정하려 해 협업 과정에서 속도가 맞지 않는 경우가 많소.",
  "충_신인": "인(寅)과 신(申)이 충하오. 한 사람은 직관적으로 빠르게 움직이려 하고, 다른 사람은 논리적으로 따져보고 결정하려 해 협업 과정에서 속도가 맞지 않는 경우가 많소.",
...
function buildCrossRelDescBiz(r: { kind: string; chars: string[] }): string {
  const key = `${r.kind}_${r.chars.join("")}`;
  const reverseKey = `${r.kind}_${[...r.chars].reverse().join("")}`;
  return CROSS_DESC_BIZ[key] ?? CROSS_DESC_BIZ[reverseKey] ?? (KIND_MEANING[r.kind as keyof typeof KIND_MEANING]?.effect ?? "");
}

const REL_SCORE_BIZ: Record<string, number> = {
  "삼합":   +12,
  "천간합": +8,
  "육합":   +7,
  "천간충": -8,
...
const SCORE_LABELS_BIZ: [number, string][] = [
  [90, "천생연분 파트너"],
  [80, "빛나는 비즈니스 인연"],
  [70, "좋은 조화"],
  [60, "무난한 궁합"],
...
function calcKunghapScoreBiz(rels: { kind: string }[]): { score: number; label: string } {
  const raw = rels.reduce((acc, r) => acc + (REL_SCORE_BIZ[r.kind] ?? 0), 70);
...
function buildHapChungDescBiz(rels: { kind: string }[], score: number): string {
  ...
  const countLine = (() => {
    if (hapCount === 0 && chungCount === 0)
      return `두 사람의 사주 사이에서 합(合)과 충(沖) 모두 발견되지 않았소. 기운의 충돌도 없지만 강한 연결도 없는, 비교적 중립적인 구조이오. 비즈니스 협업 과정에서 이 점수는 ${score}점으로 산정되었소.`;
    if (hapCount === 0)
      return `두 사람의 사주 사이에서 합(合)은 발견되지 않았고, 마찰의 기운이 ${chungCount}개 작용하고 있소. 비즈니스 협업 과정에서 이 점수는 ${score}점으로 산정되었소.`;
    if (chungCount === 0)
      return `두 사람의 사주 사이에서 합(合)이 ${hapCount}개 형성되어 있고, 충이나 형·파·해·원진은 발견되지 않았소. 마찰 없이 조화의 기운만 흐르는 드문 구조이오. 비즈니스 협업 과정에서 이 점수는 ${score}점으로 산정되었소.`;
    return `두 사람의 사주 사이에서 합(合)이 ${hapCount}개, 충·형·파·해·원진 등 마찰의 기운이 ${chungCount}개 발견되었소. 비즈니스 협업 과정에서 이 점수는 ${score}점으로 산정되었소.`;
  })();
  ...
  if (hapCount > 0) {
    ...
    if (roles.length > 0)
      parts.push(`합(合)은 두 사람 사이에서 ${roles.join(", ")}의 기운으로 작용하오. 이 합이 있는 영역에서 두 사람은 억지로 맞추지 않아도 자연스럽게 통하게 되며, 비즈니스 협업 과정에서 서로에게 힘이 되는 근원이 되오.`);
  }
  if (chungCount > 0) {
    ...
    parts.push(`충(沖)·형·파·해·원진은 두 사람 사이에서 ${chungStr}으로 작용하오. 이 기운들이 반드시 비즈니스 협업을 어렵게 만드는 것은 아니오. 충돌이 있는 자리에서 서로를 더 깊이 이해하게 되고, 마찰이 있어야 성장도 있는 법이오.`);
  }
  const conclusion = (() => {
    if (score >= 90) return `총평하자면, 두 사람의 사주 궁합은 비즈니스 파트너십의 기운을 강하게 뒷받침하는 드문 조화를 이루고 있소. 기운의 연결이 여러 겹으로 탄탄하여 함께할수록 서로에게 힘이 되고 안정이 되는 인연이오.`;
    if (score >= 80) return `총평하자면, 두 사람의 궁합은 조화로운 기운이 마찰보다 더 강하게 흐르고 있소. 협업 과정에서 자연스러운 편안함이 있고, 서로를 이해하려는 마음이 있다면 마찰도 충분히 소화해낼 수 있는 구조이오.`;
    if (score >= 70) return `총평하자면, 두 사람의 궁합은 맞는 부분과 어긋나는 부분이 공존하는 현실적인 구조이오. 협업 과정에서 서로의 다름을 인정하고 조율하는 노력 위에서 이 관계는 단단해질 수 있소.`;
    if (score >= 60) return `총평하자면, 두 사람의 궁합은 조화보다 마찰의 기운이 더 강하게 작용하고 있소. 협업 과정에서 의식적인 소통과 배려가 꾸준히 필요하오.`;
    if (score >= 50) return `총평하자면, 두 사람의 궁합은 여러 층위에서 충돌하는 기운이 강하오. 쉽게 흐르는 구조는 아니지만, 가장 어려운 궁합이 가장 강렬한 성장을 이끌기도 하오.`;
    return `총평하자면, 두 사람의 사주 궁합은 서로를 끌어당기는 기운보다 부딪히는 기운이 훨씬 강한 도전적인 구조이오. 의식적인 배려와 소통이 비즈니스 협업의 열쇠이오.`;
  })();
  parts.push(conclusion);
  return parts.join("\n\n");
}

function KunghapRelationCardBiz({ myView, partnerView, myName, partnerName, myColor, partnerColor }: {
  myView: MyeongsikView; partnerView: MyeongsikView;
  myName: string; partnerName: string;
  myColor: string; partnerColor: string;
}) {
  const [selected, setSelected] = useState<number | null>(null);
  const rels = calcCrossRelationsBiz(myView, partnerView);
  ...
  return (
    <div className="mx-5 mb-4 rounded-2xl p-3.5" style={{ background: CREAM, border: `1px solid ${INK}12` }}>
      ...
      {rels.length === 0 ? (
        ...
        const HAP_KINDS_BIZ = ["천간합", "육합", "삼합"];
        const CHUNG_KINDS_BIZ = ["천간충", "충", "형", "파", "해", "원진"];
        const hapRels  = rels.map((r, i) => ({ r, i })).filter(({ r }) => HAP_KINDS_BIZ.includes(r.kind));
        const chungRels = rels.map((r, i) => ({ r, i })).filter(({ r }) => CHUNG_KINDS_BIZ.includes(r.kind));
        ...
        const renderBtn = ({ r, i }: { r: { kind: string; chars: string[]; label: string }; i: number }) => {
          ...
          return (
            ...
            >
              <span className="text-[11px] font-medium opacity-80">{r.kind}</span>
              <span>{r.chars.join(HAP_KINDS_BIZ.includes(r.kind) ? " + " : " ↔ ")}</span>
            </button>
          );
        };
        return (
              ...
              return (
                <div className="rounded-xl px-4 py-3 mt-2" style={{ background: `${m.color}10`, borderLeft: `3px solid ${m.color}` }}>
                  <p className="text-[12px] font-bold mb-1.5" style={{ color: m.color }}>
                    {r.kind} · {r.chars.join(HAP_KINDS_BIZ.includes(r.kind) ? " + " : " ↔ ")}
                  </p>
                  <p className="text-[13px] leading-[1.9]" style={{ color: INK_SOFT, fontFamily: SERIF }}>{buildCrossRelDescBiz(r)}</p>
                </div>
              );
            })()}
          </>
...
function HapChungScoreCardBiz({ data, hapCount, chungCount }: { data: Record<string, unknown> | null; hapCount: number; chungCount: number }) {
  if (!data) return null;
    ...
    <div className="mx-5 mb-5 rounded-2xl overflow-hidden" style={{ background: WHITE, border: `1px solid ${CH6_COLOR}15`, boxShadow: "0 2px 16px rgba(0,0,0,0.05)" }}>
      <div className="px-5 pt-4 pb-2">
        <svg viewBox="0 10 220 100" style={{ width: "100%", maxHeight: 120 }}>
          <defs>
            <linearGradient id="gaugeGradBiz3" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path d={`M${cx - r},${cy} A${r},${r} 0 0,1 ${cx + r},${cy}`} fill="none" stroke="#eee" strokeWidth="18" strokeLinecap="round" />
          <path d={`M${cx - r},${cy} A${r},${r} 0 0,1 ${cx + r},${cy}`} fill="none" stroke="url(#gaugeGradBiz3)" strokeWidth="18" strokeLinecap="round" strokeDasharray={`${(s / 100) * Math.PI * r} ${Math.PI * r}`} />
          <line x1={cx} y1={cy} x2={needleX} y2={needleY} stroke={INK} strokeWidth="2.5" strokeLinecap="round" />
          <circle cx={cx} cy={cy} r="5" fill={INK} />
          <text x={cx} y={cy - 12} textAnchor="middle" fontSize="24" fontWeight="900" fill={COLOR}>{s}</text>
        </svg>
...
function BizRelationStrengthCard({ item, index }: { item: { title: string; icon?: string; desc?: string; effect?: string }; index: number }) {
    ...
    <div className="mx-5 mb-4 rounded-2xl overflow-hidden" style={{ background: "linear-gradient(160deg, #fffbee 0%, #fff8e0 100%)", border: `1px solid #e8c06040`, boxShadow: "0 1px 10px rgba(0,0,0,0.04)" }}>
      <div className="px-5 py-2.5 flex items-center gap-2" style={{ borderBottom: `1px solid #e8c06030` }}>
        ...
        <p className="text-[14px] font-black leading-tight" style={{ color: "#5a3e10" }}>
          <span style={{ color: BCH8_LIGHT }}>{ordinal} 빛</span> — {item.title}
        </p>
      </div>
      {item.desc && (
      ...
      {item.effect && (
        <div className="px-5 py-2.5 flex items-start gap-2" style={{ background: "#e8c06015" }}>
          <span className="text-[12px] font-black flex-shrink-0 mt-0.5" style={{ color: BCH8_LIGHT }}>✦</span>
...
// 파트너십 그림자(갈등) 카드 — icon + 제목 + 풀이 + 발생 상황 + 극복법
function BizRelationShadowCard({ item, index }: { item: { title: string; icon?: string; desc?: string; trigger?: string; overcome?: string }; index: number }) {
  const KOR_ORD = ["첫번째","두번째","세번째","네번째","다섯번째","여섯번째"];
  const ordinal = KOR_ORD[index] ?? `${index + 1}번째`;
  return (
    <div className="mx-5 mb-4 rounded-2xl overflow-hidden" style={{ background: "linear-gradient(160deg, #f4f5f8 0%, #eaedf3 100%)", border: `1px solid #b0b8cc40`, boxShadow: "0 1px 10px rgba(0,0,0,0.04)" }}>
      <div className="px-5 py-2.5 flex items-center gap-2" style={{ borderBottom: `1px solid #b0b8cc30` }}>
        ...
        <p className="text-[14px] font-black leading-tight" style={{ color: "#2d3748" }}>
          <span style={{ color: BCH8_SHADOW }}>{ordinal} 그림자</span> — {item.title}
        </p>
      </div>
      {item.desc && (
      ...
      {item.trigger && (
        <div className="px-5 py-2.5 flex items-start gap-2" style={{ background: "#b0b8cc15", borderBottom: item.overcome ? `1px solid #b0b8cc20` : "none" }}>
          <span className="text-[12px] font-black flex-shrink-0 mt-0.5" style={{ color: BCH8_SHADOW }}>▲</span>
...
function BizLightShadowSummaryBanner({ lightSummary, shadowSummary }: { lightSummary: string; shadowSummary: string }) {
  ...
  const lightText  = trimPrefix(lightSummary,  ["이 파트너십의 빛은 ", "이 파트너십의 빛은", "빛은 "]);
  const shadowText = trimPrefix(shadowSummary, ["이 파트너십의 그림자는 ", "이 파트너십의 그림자는", "그림자는 "]);
  return (
...
function BizLightShadowBalanceCard({ data }: { data: Record<string, unknown> | null }) {
  ...
  return (
    <div className="mb-2">
      <div className="mx-5 mb-5 rounded-2xl overflow-hidden" style={{ background: WHITE, border: `1px solid ${BCH8_COLOR}15`, boxShadow: "0 1px 10px rgba(0,0,0,0.04)" }}>
        <div className="px-5 pt-4 pb-3">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center gap-1.5">
              <span className="text-[14px]">☀️</span>
              <p className="text-[11px] font-black" style={{ color: BCH8_LIGHT }}>빛 {safeLight}%</p>
            </div>
            <div className="flex items-center gap-1.5">
              <p className="text-[11px] font-black" style={{ color: BCH8_SHADOW }}>그림자 {100 - safeLight}%</p>
              <span className="text-[14px]">🌑</span>
            </div>
          </div>
          <div className="w-full rounded-full overflow-hidden" style={{ height: 10, background: `${BCH8_SHADOW}20` }}>
            <div className="h-full rounded-full transition-all" style={{ width: `${safeLight}%`, background: `linear-gradient(90deg, ${BCH8_LIGHT} 0%, ${BCH8_LIGHT}cc 100%)` }} />
          </div>
          <p className="text-[11px] mt-2 text-center" style={{ color: MUTE }}>
            {safeLight >= 70 ? "빛이 그림자를 크게 앞서는 파트너십이오"
              : safeLight >= 55 ? "빛이 조금 더 많은 균형 잡힌 파트너십이오"
              : safeLight >= 45 ? "빛과 그림자가 팽팽히 맞서는 파트너십이오"
              : "그림자를 의식하며 빛을 키워나가야 할 파트너십이오"}
          </p>
        </div>
      </div>
      <div className="px-6">
      ...
      {tips.length > 0 && (
        <div className="mx-5 mb-4 rounded-2xl overflow-hidden" style={{ background: WHITE, border: `1px solid ${BCH8_COLOR}15` }}>
          <div className="px-5 py-3" style={{ background: `${BCH8_COLOR}08`, borderBottom: `1px solid ${BCH8_COLOR}12` }}>
            <p className="text-[12px] font-black" style={{ color: BCH8_COLOR }}>✦ 이 파트너십의 균형을 지키는 법</p>
          </div>
...
function ReportPreviewInner() {
  ...
  useEffect(() => {
    ...
    if (id) {
      fetch(`/api/kunghap_business-report?id=${encodeURIComponent(id)}`)
      ...
      fetch("/api/kunghap_business-report", {
        ...
        .then((d) => {
          ...
          if (d.resultId) router.replace(`/saju/kunghap_business/report-preview?id=${d.resultId}&gender=${encodeURIComponent(d.gender ?? gender)}`);
        })
        .catch(() => {})
        .finally(() => setLoading(false));
    }
...
<>
      ...
      {ch === "0" && (
        <>
          <div className="text-center px-6 py-4" style={{ background: "#111" }}>
            ...
            <h1 className="text-[20px] font-black leading-snug" style={{ color: "#fff", fontFamily: SERIF }}>사주궁합이란 무엇인가</h1>
          </div>
          {/* 커버 이미지 */}
          <div className="relative overflow-hidden" style={{ height: 520 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
            ...
            <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`자, 이제 두 사람의 인연을\n낱낱이 풀어보겠소.`}</p>
          </div>
        ...
        return (
          <>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_1/kunghap_business_1_1.jpg" alt="" className="w-full block" />
            ...
            {report?.sajuImageUrl && (
              <div>
                <div className="px-5">
                  ...
                  {(() => {
                    const meaning = buildSajuImageMeaning(report?.view?.pillars ?? [], `${firstName}님`);
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_1/kunghap_business_1_2.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "18%", left: "40%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[1.6] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>{firstName}님 사주에는<br />비즈니스할 때에<br />빛나는 기질과<br />조심할 기질이 있소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
      ...
      {ch === "2" && (() => {
        ...
        return (
          <>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_2/kunghap_business_2_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "20%", left: "62%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>{partnerFirstName}님의 사주팔자로<br />한폭의 그림을 그려봤소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_2/kunghap_business_2_2.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "18%", left: "44%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[1.6] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>{partnerFirstName}님 사주에도<br />비즈니스할 때에<br />빛나는 기질과<br />조심할 기질이 있소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람의 원국을 보았으니,\n이제 비즈니스 궁합 점수를\n살펴보겠소.`}</p>
            </div>
      ...
      {ch === "3" && (() => {
        ...
        const crossRels     = report?.view && report?.partnerView
          ? calcCrossRelationsBiz(report.view, report.partnerView)
          : [];
        const HAP_KINDS_BIZ3 = ["천간합", "육합", "삼합"];
        const hapCount      = crossRels.filter(r => HAP_KINDS_BIZ3.includes(r.kind)).length;
        const chungCount    = crossRels.filter(r => !HAP_KINDS_BIZ3.includes(r.kind)).length;
        const { score: computedScore, label: computedLabel } = calcKunghapScoreBiz(crossRels);
        const computedDesc  = buildHapChungDescBiz(crossRels, computedScore);
        ...
        return (
          <>
            ...
            <div className="px-8 py-12 text-center">
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사주가 만나면\n글자들이 서로 합치기도,\n충돌하기도 하오.\n\n합은 두 기운이 어우러지는 것이고,\n충은 두 기운이 부딪히는 것이오.`}</p>
            </div>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_3/kunghap_business_3_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "23%", left: "33%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[16px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>비즈니스 파트너로서<br />두 사람 사주 글자끼리<br />맞닿는 기운이 있소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            {/* 두 사람의 합(合) - LLM 카드 */}
            {(jc.hapList as {items?: Array<{effect?: string; type?: string; desc?: string}>} | undefined)?.items && (jc.hapList as {items: Array<{effect?: string; type?: string; desc?: string}>}).items.length > 0 && (
              <section className="pb-4">
                <div className="px-5"><Heading>두 사람의 합(合)은</Heading></div>
                {(jc.hapList as {items: Array<{effect?: string; type?: string; desc?: string}>}).items.map((item, i) => (
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_3/kunghap_business_3_2.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "22%", left: "68%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[16px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>비즈니스 파트너로서<br />두 사람 사주 글자끼리<br />충돌하는 기운도 있소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            {/* 두 사람의 충(沖) - LLM 카드 */}
            {(jc.chungList as {items?: Array<{impact?: string; type?: string; desc?: string; resolve?: string}>} | undefined)?.items && (jc.chungList as {items: Array<{impact?: string; type?: string; desc?: string; resolve?: string}>}).items.length > 0 && (
              <section className="pb-4">
                <div className="px-5"><Heading>두 사람의 충(沖)은</Heading></div>
                {(jc.chungList as {items: Array<{impact?: string; type?: string; desc?: string; resolve?: string}>}).items.map((item, i) => (
      ...
      {ch === "4" && (() => {
        ...
        return (
          <>
            ...
            <div className="px-8 py-12 text-center">
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람이 만나서\n함께 시너지를 낼 수 있을지\n하나씩 살펴보겠소.`}</p>
            </div>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_4/kunghap_business_4_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "20%", left: "65%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>두 사람의<br />강점은 더 빛나게 하고<br />약점은 잘 보완케 하는<br />방법을 알려주겠소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람의 강점과 약점을 살폈으니,\n이제 함께 일할 때\n어떤 파트너가 되는지 보겠소.`}</p>
            </div>
        ...
        return (
          <>
            <div className="text-center px-6 py-4" style={{ background: "#111" }}>
              ...
              <h1 className="text-[20px] font-black leading-snug" style={{ color: "#fff", fontFamily: SERIF }}>우린 어떤 파트너가 될까</h1>
            </div>
            <div className="relative overflow-hidden" style={{ height: 520 }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <div className="px-8 py-12 text-center">
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람이 함께 일하면\n어떤 그림이 펼쳐지는지,\n하나씩 들여다보겠소.`}</p>
            </div>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_5/kunghap_business_5_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "22%", left: "75%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[14px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>사주가 다르면<br />잘하는 것도 다르오.<br />그것이 파트너십이오.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람이 함께\n일하는 모습을 살펴봤소.\n\n이제 두 사람의\n비즈니스 스타일 차이를 보겠소.`}</p>
            </div>
      ...
      {ch === "6" && (() => {
        ...
        return (
          <>
            ...
            <div className="px-8 py-12 text-center">
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`궁합 점수와 별개로,\n사람마다 일하는 방식이 다르오.\n\n스타일이 맞으면\n점수가 낮아도 잘 굴러가고,\n\n스타일이 어긋나면\n점수가 높아도 삐걱거리오.\n\n두 사람의 차이를 살펴보겠소.`}</p>
            </div>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_6/kunghap_business_6_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "23%", left: "68%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>함께 일하는 방식,<br />서로를 알아야<br />잘 맞출 수 있소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`스타일의 차이를 알았으니,\n이 파트너십의 빛과 그림자를\n살펴보겠소.`}</p>
            </div>
      ...
      {ch === "7" && (() => {
        ...
        return (
          <>
            ...
            <div className="px-8 py-12 text-center">
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`모든 파트너십에는\n빛도 있고 그림자도 있소.\n\n빛만 있으면 눈이 멀고,\n그림자만 있으면 앞이 보이지 않소.\n\n두 사람의 사업 파트너십에서\n그 둘을 살펴보겠소.`}</p>
            </div>

            {(lightSummary || shadowSummary) && (
              <section className="pb-4">
                <div className="px-5"><Heading>두 사람의 빛과 그림자</Heading></div>
                <BizLightShadowSummaryBanner lightSummary={lightSummary} shadowSummary={shadowSummary} />
              </section>
            )}

            {strengthItems.length > 0 && (
              <section className="pb-4">
                <div className="px-6"><Heading>두 사람의 빛</Heading></div>
                {strengthItems.map((item, i) => <BizRelationStrengthCard key={i} item={item} index={i} />)}
              </section>
            )}

            {shadowItems.length > 0 && (
              <section className="pb-4">
                <div className="px-5"><Heading>두 사람의 그림자</Heading></div>
                {shadowItems.map((item, i) => <BizRelationShadowCard key={i} item={item} index={i} />)}
              </section>
            )}
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_7/kunghap_business_7_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "17%", left: "65%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>밝은 면과 어두운 면,<br />둘 다 알아야<br />진짜 파트너요.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            {balance && (
              <section className="pb-4">
                ...
                <BizLightShadowBalanceCard data={balance} />
              </section>
            )}

            <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`빛과 그림자를 알았으니,\n이제 위기는 언제 오는지\n짚어보겠소.`}</p>
            </div>
      ...
      {ch === "8" && (() => {
        ...
        return (
          <>
            ...
            <div className="px-8 py-12 text-center">
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람의 사업이\n어떤 시기를 타고 흘러가는지\n살펴보겠소.`}</p>
            </div>
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_8/kunghap_business_8_1.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "22%", left: "34%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[17px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>어떤 해, 어떤 달에<br />기운이 오르고 내리는지<br />말해주겠소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_8/kunghap_business_8_2.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "20%", left: "50%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>함께 펼칠 사업,<br />성공 가능성을<br />점쳐보겠소.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="relative w-full mt-8">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/media/report/kunghap_business/kunghap_business_8/kunghap_business_8_3.jpg" alt="" className="w-full block" />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(253,248,244,1) 100%)" }} />
              <div className="absolute pointer-events-none" style={{ top: "15%", left: "65%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[18px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>알고 실천하면<br />사업의 흐름이<br />달라지오.</p>
              </div>
            </div>
            <div style={{ display: "flex", justifyContent: "center", paddingTop: 40, paddingBottom: 32 }}>
              <div style={{ width: 1, height: 48, background: "#ccc" }} />
            ...
            <div className="px-8 py-10 text-center" style={{ background: `linear-gradient(to bottom, ${CREAM}, ${PINK_PALE})` }}>
              <div style={{ width: 1, height: 48, background: "#ccc", margin: "0 auto 32px" }} />
              <p className="text-[17px] leading-[2.1] whitespace-pre-line" style={{ color: INK, fontFamily: SERIF }}>{`두 사람의 사업 흐름을\n살펴보았으니,\n홍연의 마지막 서신을 받으시오.`}</p>
            </div>
            ...
            {(() => {
              ...
              return (
                <div className="mb-8">
                  ...
                  {/* 구분선 */}
                  <div className="mt-8 mb-8" style={{ height: 1, background: `${INK_SOFT}12` }} />
                </div>
              );
            })()}
