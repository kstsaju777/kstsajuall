...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/kunghap_business/report-preview?${reportParams.toString()}`;

    router.push(`/saju/kunghap_business/report-preview?${reportParams.toString()}`);
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ backgroundColor: CREAM }}>
      <div className="flex-1 min-h-0 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        ...
        {/* ① 헤더 이미지 + 제목 */}
        <ImageTextBlock
          topImgSrc="/media/cards/kunghap_business/jaehwe-1.jpg"
          bottomImgSrc="/media/cards/kunghap_business/jaehwe-2.jpg"
          label="비즈니스궁합 · 정밀 리포트"
          headline={`${name}님과\n${partnerName}님의 인연,\n낱낱이 봤어요`}
          accentWord="낱낱이"
          bgColor={WHITE}
        ...
        <ImageDivider src="/media/cards/kunghap_business/jaehwe-2.jpg" bgColor={CREAM} />
