...
const WHITE    = "#ffffff";
const RED      = "#4e9eff";
const RED_SOFT = "#74b3ff";
const RED_PALE = "#eef5ff";
const ROSE     = "#a8d0ff";
const GRAY1    = "#1a1a1a";
const GRAY2    = "#444444";
const GRAY3    = "#888888";
...
function formatDateLabel(date: string, calendar: string, gender: string) {
  ...
  return dateFormatted ? `${calLabel} ${dateFormatted}${genderLabel ? ` (${genderLabel})` : ""}` : "";
}
  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="relative">
        ...
        <img src="/media/checkout/kunghap_business/s2.jpg" alt="" className="w-full block" />
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "12.85%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두 사람 사주로 그린</p>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "18.9%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님의 사주가`}</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>서로 어떤 힘을 보태는지 보이는군.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "27.6%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>좋은 점만 있는 인연은 없소.</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>약점까지 솔직히 짚어드리겠소.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "34.35%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>각자의 사주팔자 글자간</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>합하거나 충하는 글자들이 무엇인지</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "47.55%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>아이디어는 누가 내고,</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>실행은 누가 할지도 보이는군.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "59.0%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>일하는 방식이 어떻게 다른지도</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>사주가 낱낱이 보여주는군.</p>
        </div>
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "67.7%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>앞으로 10년간 흐르는</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>사업 기운의 오르내림도 보여드리오.</p>
        </div>
        <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "4.5%", left: "65%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
        ...
        <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "91.63%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>해마다 달마다 흐르는</p>
          <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>사업 기운까지 짚어드리오.</p>
        </div>
        <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "82.5%", left: "35%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
...
const FAQS = [
  ...
  { q: "어떤 궁합 항목을 분석하나요?", a: "두 사람의 기질 분석, 비즈니스 궁합 점수, 역할 분담, 사업 시기, 협업을 방해하는 요인 등 총 14장에 걸쳐 상세히 풀이하오." },
];
...
// ─── 결제 모달 ────────────────────────────────────────────────────────────────
const PRODUCT = { name: "비즈니스궁합", original: 49800, discount: 40, price: 29900 };
      ...
      <div className="fixed bottom-0 z-50 overflow-y-auto rounded-t-3xl"
        ...
        <div className="px-5 pt-2 pb-7">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-[18px] font-black" style={{ color: DTXT }}>비즈니스궁합 결제 안내</h3>
          ...
          <div className="inline-block text-[13px] font-bold px-3.5 py-1.5 rounded-full mb-5"
            style={{ background: "rgba(78,158,255,0.16)", border: `1px solid ${ACCENT}55`, color: "#a8d0ff" }}>
            ...
            <div className="w-full text-left rounded-2xl px-4 py-3.5"
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-[11.5px] mt-1" style={{ color: DMUTE }}>홍연이 들려주는 두 사람의 비즈니스 궁합 이야기</p>
                </div>
                <div className="text-right flex-shrink-0">
                  <p className="text-[11px]" style={{ color: DSTRIKE }}>
                    <span style={{ color: "#4e9eff", fontWeight: 700 }}>{PRODUCT.discount}%</span>{" "}
          ...
          <div className="space-y-1.5 mb-4">
            ...
            <div className="flex items-center justify-between text-[13px]">
              <span style={{ color: "#4e9eff", fontWeight: 700 }}>지금 결제 시 할인 ({PRODUCT.discount}% 특가)</span>
          ...
          <button onClick={onConfirm}
            ...
            style={{ background: "linear-gradient(135deg, #74b3ff, #4e9eff)", boxShadow: "0 6px 20px rgba(78,158,255,0.4)" }}>
            결제하기
          </button>
        ...
        <div className="fixed z-[60] px-6"
          ...
          <div className="relative mx-auto rounded-2xl px-5 py-4"
            ...
            <button onClick={() => setConfirmExit(false)}
              ...
              style={{ background: "linear-gradient(135deg, #74b3ff, #4e9eff)" }}>혜택 받고 계속하기</button>
...
const TIME_COLORS: Record<string, string> = {
  "방금": "#4e9eff", "방금 전": "#4e9eff",
  "1분 전": "#2b7de9", "2분 전": "#2b7de9",
      ...
      <div style={{ position: "fixed", bottom: 100, right: "max(8px, calc(50vw - 232px))", zIndex: 49, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, pointerEvents: "none" }}>
        {toasts.map((t) => (
          <div key={t.id} style={{ animation: "toastInRight 0.35s ease", display: "flex", alignItems: "center", gap: 6, backgroundColor: "rgba(0,0,0,0.7)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 9999, padding: "6px 14px", fontSize: 12, color: "#fff", whiteSpace: "nowrap", backdropFilter: "blur(6px)" }}>
            <span style={{ backgroundColor: TIME_COLORS[t.time] ?? "#2b7de9", color: "#fff", fontSize: 10, fontWeight: 700, borderRadius: 9999, padding: "2px 7px" }}>{t.time}</span>
...
function StickyPayCTA({ onPay }: { onPay: () => void; name: string; partnerName: string }) {
  ...
  return (
    <div className="fixed bottom-0 flex items-center gap-3 px-4 z-50"
      ...
      <style>{`
        @keyframes businessBtnNeon {
          0%   { background: #4e9eff; box-shadow: 0 0 12px 3px rgba(78,158,255,0.7); }
          33%  { background: #2b7de9; box-shadow: 0 0 12px 3px rgba(43,125,233,0.7); }
          66%  { background: #74b3ff; box-shadow: 0 0 12px 3px rgba(116,179,255,0.7); }
          100% { background: #4e9eff; box-shadow: 0 0 12px 3px rgba(78,158,255,0.7); }
        }
        @keyframes businessBtnBeat {
      ...
      <button onClick={onPay}
        ...
        style={{ animation: "businessBtnNeon 3s ease-in-out infinite, businessBtnBeat 2s ease-in-out infinite" }}>
        비즈니스궁합 확인하기
      </button>
    </div>
  );
...
const CHAPTER_TITLES = [
  "제1장 — 나의 원국", "제2장 — 상대 원국", "제3장 — 궁합 점수",
  "제4장 — 강점·약점", "제5장 — 역할 분담", "제6장 — 합·충",
  "제7장 — 금전·수익", "제8장 — 갈등 패턴", "제9장 — 위기 시기",
...
function CreatingScreen({ doneCount, currentChapter }: { doneCount: number; currentChapter: number }) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 px-8"
      style={{ background: "radial-gradient(ellipse at 50% 40%, #000d1a 0%, #00050f 100%)" }}>
      <style>{`
        @keyframes shimmer { 0%{transform:translateX(-100%)} 100%{transform:translateX(400%)} }
        @keyframes glow-pulse { 0%,100%{box-shadow:0 0 8px 2px #4e9effaa,0 0 20px 4px #2266cc55} 50%{box-shadow:0 0 16px 4px #77bbffcc,0 0 40px 10px #4e9eff88} }
      ...
      <div className="relative w-20 h-20 mb-6">
        <div className="absolute inset-0 rounded-full" style={{ background: "radial-gradient(circle, #4e9eff22 0%, transparent 70%)" }} />
        {[0,1,2,3,4,5].map(i => (
          <div key={i} className="absolute w-1 h-1 rounded-full" style={{
            top: "50%", left: "50%", marginTop: "-2px", marginLeft: "-2px",
            background: i % 2 === 0 ? "#77bbff" : "#aaddff",
            boxShadow: `0 0 6px 2px ${i % 2 === 0 ? "#4e9eff" : "#66bbff"}`,
            animation: `orbit ${2.5 + i * 0.4}s linear infinite`,
            animationDelay: `${i * -0.5}s`,
          }} />
        ))}
        <div className="absolute inset-0 flex items-center justify-center">
          <span style={{ fontSize: 28, filter: "drop-shadow(0 0 8px #4e9eff)" }}>✦</span>
        </div>
      </div>
      <p className="text-[18px] font-bold mb-1" style={{ color: "#fff5ee", fontFamily: "'Noto Serif KR', serif", textShadow: "0 0 20px #4e9eff88" }}>
        결과지를 완성하고 있소…
      </p>
      <p key={currentChapter} className="text-[13px] mb-8" style={{ color: "#77bbff", animation: "title-fade 4s ease-in-out", minHeight: 20 }}>
        {doneCount < TOTAL ? CHAPTER_TITLES[currentChapter - 1] + " 풀이 중" : "마무리 중이오…"}
      </p>
      <div className="w-full max-w-[280px] mb-3">
        <div className="flex justify-between text-[11px] mb-2" style={{ color: "#3388bb" }}>
          <span>{doneCount} / {TOTAL} 장 완성</span>
          <span>{pct}%</span>
        </div>
        <div className="w-full h-3 rounded-full overflow-hidden relative" style={{ background: "#001020" }}>
          <div className="h-full rounded-full relative overflow-hidden transition-all duration-700"
            style={{ width: `${pct}%`, background: "linear-gradient(90deg, #0a3366, #4e9eff, #77ccff)", animation: pct > 0 ? "glow-pulse 1.8s ease-in-out infinite" : "none" }}>
      ...
      <p className="text-[11px] text-center leading-relaxed mt-4" style={{ color: "#225588" }}>
...
const PRODUCT_INFO = { name: "사업궁합", price: 29900 };
  ...
  return (
    <div className="w-full h-full" style={{ backgroundColor: WHITE }}>
      <div className="w-full h-full overflow-y-auto" style={{ scrollbarWidth: "none", paddingBottom: 80 }}>
        ...
        {/* ① 상단 이미지 */}
        <div className="relative">
          <img src="/media/checkout/kunghap_business/s1.jpg" alt="" className="w-full block" />
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "26%", left: "69%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님`}</p>
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "54.8%", left: "40.5%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>비즈니스궁합을 보기 전에</p>
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님의 사주팔자가`}</p>
          ...
          <div className="absolute flex flex-col items-center gap-1 pointer-events-none" style={{ top: "95.5%", left: "60%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap" }}>
            ...
            <p style={{ fontSize: 22, fontWeight: 400, color: "#000000" }}>{`${stripSurname(name)}님과 ${stripSurname(partnerName)}님의`}</p>
        ...
        {/* ③ 하단 이미지 */}
        <div className="relative">
          <img src="/media/checkout/kunghap_business/s3.jpg" alt="" className="w-full block" />
          <div className="absolute bottom-0 left-0 right-0 h-16 pointer-events-none" style={{ background: `linear-gradient(to bottom, transparent, ${WHITE})` }} />
          <div className="absolute flex flex-col items-center pointer-events-none" style={{ top: "2.7%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", whiteSpace: "nowrap", fontFamily: "'GmarketSans', sans-serif", fontWeight: 700 }}>
            <p style={{ fontSize: 22, color: "#000000", lineHeight: 1.4 }}>두사람 사업궁합에 대해</p>
          ...
          <div className="fixed bottom-0 z-[60] rounded-t-3xl overflow-hidden"
            ...
            <div className="toss-widget-wrap">
              <TossWidget
                ...
                successUrl={`${typeof window !== 'undefined' ? window.location.origin : 'https://www.hongyeondang.com'}/saju/kunghap_business/checkout/success`}
...
export default function KunghapBusinessCheckoutPage() {
  return (
    <Suspense fallback={
