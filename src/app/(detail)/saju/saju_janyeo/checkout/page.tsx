  ...
  return (
    <div className="rounded-2xl overflow-hidden"
      ...
      <div className="py-2.5 text-center" style={{ backgroundColor: RED_PALE, borderBottom: `1px solid ${ROSE}` }}>
        <p className="text-[15px] font-bold" style={{ color: "#1a6a8a" }}>{label}</p>
      </div>
      <div className="p-3">
        <div className="grid grid-cols-4 gap-1.5">
          {(pillars ?? Array(4).fill(null)).map((p, i) => (
            <div key={i} className="flex flex-col items-center gap-0">
              ...
              <span style={{ fontSize: 13, color: "#1a6a8a", lineHeight: 1, marginBottom: 6 }}>{p?.stemSs || " "}</span>
              ...
              <span style={{ fontSize: 13, color: "#1a6a8a", lineHeight: 1, marginTop: 6 }}>{p?.branchSs || " "}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="px-6 pt-10 pb-5 text-center">
        <p className="text-[11px] tracking-[0.2em] mb-3 font-medium" style={{ color: "#1a6a8a" }}>자녀사주 · 정밀 리포트</p>
        <h1 className="text-[26px] font-black leading-snug" style={{ color: GRAY1 }}>
          {name}의 미래,<br />
          사주가 <span style={{ color: "#1a6a8a" }}>모두</span> 알고 있소
        </h1>
        <p className="text-[13px] mt-3 leading-relaxed" style={{ color: GRAY2 }}>
          아이의 타고난 기질과 인생의 흐름을<br />
          낱낱이 풀었소. 지금 확인하시오.
        </p>
      </div>
      ...
      <div className="relative overflow-hidden w-full" style={{ aspectRatio: "9/16" }}>
        ...
        <video
          src="/media/cards/saju_janyeo/janyeo-0.mp4"
  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      <div className="px-5 pb-2 pt-6">
        <p className="text-center text-[13px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#1a6a8a" }}>✦ 사주 명식 ✦</p>
        <p className="text-center text-[17px] font-bold mb-4" style={{ color: GRAY1 }}>{name}의 팔자가 품은 이야기</p>
        <div ref={ref} style={{ ...style, display: "flex", justifyContent: "center" }}>
          <div style={{ width: "100%", maxWidth: 280 }}>
            <MyeongsikCard saju={saju} label={`${name}`} />
          </div>
        </div>
      </div>
      <div className="h-6" />
...
const PREVIEW_SECTIONS = [
  {
    ...
    content: "일간과 오행 구성을 바탕으로 아이의 타고난 기질을 분석합니다. 어떤 환경에서 잘 자라는지, 어떤 분야에 소질이 있는지, 타고난 성격과 학습 방식까지 사주 속에 고스란히 담겨 있습니다.\n\n친구 관계에서 어떻게 행동하는지, 반복되는 성장 패턴까지 사주는 조용히 기록하고 있습니다.",
    blurLines: [],
  },
  {
    icon: "⭐", title: "타고난 재능과 적성", free: false,
    content: "",
    blurLines: [
      "████ 분야에서 뛰어난 재능이 보입니다.",
      "████한 학습 방식이 아이에게 가장 잘 맞습니다.",
      "████ 방향으로 키워주면 큰 성취를 이룰 수 있습니다.",
    ],
  },
  {
    icon: "📅", title: "성장 시기와 흐름", free: false,
    content: "",
    blurLines: [
      "████년 ████월, 아이에게 중요한 전환점이 옵니다.",
      "이 시기에 ████한 지원이 큰 도움이 됩니다.",
      "다음 성장 파동은 ████년 이후로 이어집니다.",
    ],
  },
  {
    icon: "🤝", title: "인간관계와 사회성", free: false,
    content: "",
    blurLines: [
      "아이의 사주에서 ████한 인간관계 패턴이 보입니다.",
      "████한 환경이 사회성 발달에 도움이 됩니다.",
      "████한 또래 관계가 아이에게 특히 중요합니다.",
    ],
  },
  {
    icon: "🛡️", title: "주의해야 할 시기", free: false,
    content: "",
    blurLines: [
      "당신의 아이는 ████ 시기에 특별한 관심이 필요합니다.",
      "████한 환경 변화는 아이에게 ████한 영향을 줍니다.",
    ...
    <div className="mx-5 mb-4 rounded-2xl overflow-hidden"
      ...
      <div className="flex items-center gap-2.5 px-4 py-3.5"
        ...
        <span className="ml-auto text-[10px] px-2.5 py-0.5 rounded-full font-medium"
          style={{ backgroundColor: s.free ? `${RED}30` : "#f5f5f5", color: s.free ? "#1a6a8a" : GRAY3, border: `1px solid ${s.free ? RED : GRAY4}` }}>
          {s.free ? "✓ 공개" : "🔒 잠김"}
        </span>
      </div>
          ...
          <div className="relative py-1">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
              <div className="w-9 h-9 rounded-full flex items-center justify-center"
                ...
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1a6a8a" strokeWidth="2.5">
                  <rect x="3" y="11" width="18" height="11" rx="2"/>
                  <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
                </svg>
              </div>
              <span className="text-[11px] font-semibold" style={{ color: "#1a6a8a" }}>결제 후 열람 가능</span>
            </div>
          </div>
        )}
      </div>
  ...
  return (
    <div ref={ref} style={{
      ...
      <div className="pt-7 pb-2 text-center px-5">
        <p className="text-[11px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#1a6a8a" }}>✦ AI 정밀 분석 · 14장 ✦</p>
        <h2 className="text-[20px] font-black mb-1.5" style={{ color: GRAY1 }}>아이의 미래, 이제 확인하오</h2>
...
const CHAPTER_LIST = [
  ...
  { ch: 2,  title: "타고난 기질",        emoji: "🌱" },
  { ch: 3,  title: "타고난 재능",        emoji: "⭐" },
  { ch: 4,  title: "학습 방식",          emoji: "📚" },
  { ch: 5,  title: "성격과 심리",        emoji: "🧠" },
  { ch: 6,  title: "사회성",            emoji: "🤝" },
  { ch: 7,  title: "성장 주의 시기",     emoji: "📅" },
  { ch: 8,  title: "대운 흐름",          emoji: "🌊" },
  { ch: 9,  title: "귀인과 도움",        emoji: "✨" },
  { ch: 10, title: "주의할 환경",        emoji: "⚠️" },
  { ch: 11, title: "직업 방향",          emoji: "🎯" },
  { ch: 12, title: "건강",              emoji: "🌿" },
...
function TableOfContents() {
  ...
  return (
    <div ref={ref} className="px-5 py-7" style={{
      ...
      <p className="text-center text-[11px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#1a6a8a" }}>✦ 목차 ✦</p>
      ...
      <div className="space-y-2">
        {CHAPTER_LIST.map(({ ch, title, emoji }, i) => (
          <div key={ch} className="flex items-center gap-3 px-3 py-2.5 rounded-xl"
            ...
            <span className="text-[12px] font-medium flex-shrink-0" style={{ color: "#1a6a8a", minWidth: 32 }}>제{ch}장</span>
...
// ─── 후기 섹션 ───────────────────────────────────────────────────────────────
const REVIEWS = [
  { star: 5, text: "아이의 기질 분석이 소름돋을 정도로 맞았어요. 왜 그런 행동을 하는지 이제야 이해가 됐습니다.", name: "30대 주부 김○○", date: "2025.05.12" },
  { star: 5, text: "성장 전환점이 딱 맞았어요. 미리 알고 준비했더니 아이가 잘 넘길 수 있었습니다.", name: "40대 직장인 이○○", date: "2025.04.28" },
  { star: 5, text: "타고난 재능 분석이 정말 도움됐어요. 어떤 방향으로 지원해야 할지 명확해졌습니다.", name: "30대 자영업자 박○○", date: "2025.05.03" },
  { star: 5, text: "막연하게 걱정됐는데, 아이의 미래를 딱 짚어줘서 앞으로 어떻게 도와줘야 할지 결심이 서더라구요.", name: "40대 주부 최○○", date: "2025.06.01" },
];

function ReviewSection() {
  return (
    <div className="px-5 py-7" style={{ backgroundColor: CREAM }}>
      <p className="text-center text-[11px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#1a6a8a" }}>✦ 실제 후기 ✦</p>
...
const FAQS = [
  ...
  { q: "어떤 항목을 분석하나요?", a: "타고난 기질, 재능과 적성, 학습 방식, 성장 시기, 인간관계 등 총 14장에 걸쳐 상세히 풀이하오." },
...
function FAQSection() {
  ...
  return (
    <div className="px-5 py-7" style={{ backgroundColor: WHITE }}>
      <p className="text-center text-[11px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#1a6a8a" }}>✦ FAQ ✦</p>
...
const CHAPTER_TITLES = [
  "제1장 — 사주 원국", "제2장 — 타고난 기질", "제3장 — 타고난 재능",
  "제4장 — 학습 방식", "제5장 — 성격과 심리", "제6장 — 사회성",
  "제7장 — 성장 주의 시기", "제8장 — 대운 흐름", "제9장 — 귀인과 도움",
  "제10장 — 주의할 환경", "제11장 — 직업 방향", "제12장 — 건강",
  "제13장 — 당부의 말", "제14장 — 개운법",
];
const TOTAL = 14;
...
function CheckoutContent() {
  ...
  const handleConfirm = async () => {
    ...
    setCurrentChapter(1);
    try {
      const res = await fetch("/api/saju_janyeo-report", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ name, date, time, calendar, gender, email }),
      });
      if (!res.ok) {
        router.push(`/saju/saju_janyeo/report-preview?${new URLSearchParams({ name, gender }).toString()}`);
        return;
      }
      ...
      await Promise.all(chapters.map(async (ch) => {
        try {
          const r = await fetch("/api/saju_janyeo-report", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
  ...
  return (
    <div className="w-full h-full" style={{ backgroundColor: WHITE }}>
      <div className="w-full h-full overflow-y-auto" style={{ scrollbarWidth: "none", paddingBottom: 80 }}>
        ...
        {/* ① 히어로 */}
        <HeroSection name={`${name}${suffix}`} />

        {/* ② 명식 */}
        <MyeongsikSection saju={saju} name={`${name}${suffix}`} />
