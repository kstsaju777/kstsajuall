...
export default function YeonaeSajuPage() {
  const router = useRouter();
  ...
  return (
    <div className="w-full relative" style={{height:"100dvh",backgroundColor:BG,overflow:"hidden"}}>
      ...
      <video src="/media/cards/saju_yeonae/saju_yeonae-small-0.mp4" autoPlay muted loop playsInline style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"15% 15%"}}/>
      <style>{`
      ...
      `}</style>
      {[
        {top:"72px",left:"5%",appearDelay:"1s",floatDelay:"1.6s",floatAnim:"floatA",name:"오*준",stars:5,text:"솔로인 이유가 사주에 있었네요 진짜 신기했어요 💘"},
        {top:"24%",left:"5%",appearDelay:"2s",floatDelay:"2.6s",floatAnim:"floatB",name:"서*아",stars:5,text:"연애 시작되는 시기 딱 맞아서 소름돋았어요!"},
        {top:"45%",left:"4%",appearDelay:"3s",floatDelay:"3.6s",floatAnim:"floatC",name:"신*우",stars:5,text:"어떤 스타일이 잘 맞는지 나와서 도움 됐어요 ㅎㅎ"},
      ].map((r,i)=>(
      ...
      <img src="/media/cards/saju_yeonae/typo-yeonae.png" alt="" style={{position:"absolute",bottom:"145px",left:"7.5%",width:"85%",objectFit:"contain",pointerEvents:"none",zIndex:41}}/>
