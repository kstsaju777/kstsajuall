  ...
  return (
    <div className="w-full flex flex-col relative" style={{ backgroundColor: BG }}>
      ...
      <div style={{ fontSize: 0 }}>
        <img src="/media/cards/saju_yeonae/saju_yeonae-0.jpg" alt="연애운사주"
          style={{ display: "block", width: "100%", height: "auto" }} />
      </div>

      {/* 리포트 미리보기 */}
      <div style={{ backgroundColor: "#0f0f14", padding: "32px 20px 40px" }}>
        <p style={{ fontSize: 13, color: PINK, fontWeight: 700, marginBottom: 6 }}>연애운사주</p>
        ...
        <div style={{ background: "#1a1a22", borderRadius: 16, overflow: "hidden", marginBottom: 8 }}>
          <img src="/media/cards/saju_yeonae/saju_yeonae-0.jpg" alt="미리보기"
            style={{ display: "block", width: "100%", height: "auto" }} />
          <div style={{ padding: "20px 20px 24px" }}>
            <p style={{ fontSize: 12, color: PINK, fontWeight: 700, marginBottom: 4 }}>+15,000자</p>
            <p style={{ fontSize: 22, color: "#fff", fontWeight: 900, marginBottom: 12 }}>2026 연애운사주</p>
