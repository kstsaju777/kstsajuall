...
function CheckoutContent() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const reportUrl = d?.resultId ? `https://www.hongyeondang.com/saju/saju_yeonae/report?id=${d.resultId}` : `https://www.hongyeondang.com/saju/saju_yeonae/report?${new URLSearchParams({ name, date, time, calendar, gender, email, ch: "0" }).toString()}`;
