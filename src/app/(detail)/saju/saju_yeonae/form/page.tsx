      ...
      <div className="px-6 pt-4 pb-3 overflow-y-auto" style={{ backgroundColor: CARD_BG, maxHeight: "70vh" }}>
        ...
        {showDate && (
          <div style={{ animation: "slideUp 0.35s ease" }}>
            ...
            <p className="text-[12px] font-medium mb-0.5" style={{ color: "#8a8a8a" }}>그대의 생년월일</p>
            <h2 className="text-[20px] mb-3" style={{ color: TEXT_CLR }}>
            ...
            {dateEntered && (
              <div style={{ animation: "slideUp 0.35s ease" }}>
                ...
                <p className="text-[12px] font-medium mb-0.5" style={{ color: "#8a8a8a" }}>그대의 태어난 시간</p>
                <h2 className="text-[20px] mb-3" style={{ color: TEXT_CLR }}>
                  <span className="font-normal" style={{ color: "rgba(245,245,245,0.45)" }}>그대가 </span>
    ...
    <>
      <div className="px-6 pt-4 pb-3" style={{ backgroundColor: CARD_BG }}>
        ...
        <h2 className="text-[20px] mb-4" style={{ color: TEXT_CLR }}>
          <span className="font-bold" style={{ color: TEXT_CLR }}>{name ?? "그대"}{gender === "남성" ? "군" : gender === "여성" ? "양" : "님"} </span>
          ...
          <div className="grid grid-cols-4 gap-2">
            {(pillars ?? Array(4).fill(null)).map((p, i) => (
              <div key={i} className="flex flex-col items-center gap-1.5">
                ...
                <span style={{ fontSize: 13, color: "#e9bdae", lineHeight: 1, fontWeight: 700 }}>{p?.stemSs || " "}</span>
                ...
                <span style={{ fontSize: 13, color: "#e9bdae", lineHeight: 1, fontWeight: 700 }}>{p?.branchSs || " "}</span>
              </div>
            ))}
          </div>
        </div>
        <div className="rounded-2xl px-4 py-3" style={{ backgroundColor: "rgba(233,189,174,0.07)", border: "1px solid rgba(233,189,174,0.25)" }}>
          <p className="text-[13px] leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>
            <span style={{ color: TEXT_CLR, fontWeight: 700 }}>{name ?? "그대"}{gender === "남성" ? "군" : gender === "여성" ? "양" : "님"}</span>의 사주팔자를 살펴봤소.
  ...
  return (
    <div className="relative flex flex-col items-center justify-center" style={{ minHeight: "100dvh", backgroundColor: "#080a0f" }}>
      ...
      <div className="relative z-10 px-8 w-full max-w-sm text-center">
        ...
        <p className="text-[22px] font-black mb-1" style={{ color: "#fff" }}>{name} 사주</p>
