...
function CheckoutContent() {
  ...
  const handleConfirm = () => {
    ...
    const reportUrl = `https://www.hongyeondang.com/saju/saju_ehon/report-preview?${reportParams.toString()}`;
    router.push(`/saju/saju_ehon/report-preview?${reportParams.toString()}`);
    if (email) {
      try {
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ backgroundColor: CREAM }}>
      <div className="flex-1 min-h-0 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        ...
        {/* ① 헤더 이미지 + 제목 */}
        <ImageTextBlock
          topImgSrc="/media/cards/saju_ehon/jaehwe-1.jpg"
          bottomImgSrc="/media/cards/saju_ehon/jaehwe-2.jpg"
          label="이혼사주 · 정밀 리포트"
          headline={`${name}님과\n${partnerName}님의 인연,\n낱낱이 봤어요`}
          accentWord="낱낱이"
          bgColor={WHITE}
        ...
        {/* ③ 분석 섹션 헤더 */}
        <ImageTextBlock
          topImgSrc="/media/cards/saju_ehon/jaehwe-3.jpg"
          bottomImgSrc="/media/cards/saju_ehon/jaehwe-1.jpg"
        ...
        <ImageDivider src="/media/cards/saju_ehon/jaehwe-2.jpg" bgColor={CREAM} />
