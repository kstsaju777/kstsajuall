          ...
          <section className="pt-6 pb-12">
            ...
            <div className="relative w-full mt-8">
              ...
              <div className="absolute pointer-events-none" style={{ top: "18%", left: "75%", transform: "translate(-50%, -50%)" }}>
                <p className="text-[15px] font-bold leading-[2] text-center whitespace-nowrap" style={{ color: "#2a2320", fontFamily: "'Nanum Myeongjo', 'Apple SD Gothic Neo', serif" }}>{honorShort}의 사주팔자로<br />한폭의 그림을 그려봤소.</p>
              </div>
            </div>
