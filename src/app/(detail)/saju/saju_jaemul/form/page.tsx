...
// ─── 정보 입력 (성별 + 날짜 + 시간 + 이름) ──────────────────────────────────
function StepInfo({ onPrev, onNext, initial }: {
  onPrev: () => void;
  ...
  return (
    <>
      ...
      <div className="px-6 pt-4 pb-3 overflow-y-auto" style={{ backgroundColor: CARD_BG, maxHeight: "70vh" }}>
        {/* 성별 */}
        <p className="text-[12px] font-medium mb-0.5" style={{ color: "#8a8a8a" }}>성별</p>
        ...
        <div className="flex gap-3 mb-4">
          {["남성", "여성"].map((label) => (
            <button key={label} onClick={() => { setGender(label); setShowDate(true); }}
              ...
              style={{
                backgroundColor: gender === label ? "rgba(249,220,100,0.12)" : "rgba(255,255,255,0.04)",
                border: `2px solid ${gender === label ? GOLD : "rgba(255,255,255,0.1)"}`,
                color: gender === label ? GOLD : "rgba(255,255,255,0.6)",
              }}>
              {label}
            </button>
          ))}
        ...
        {showDate && (
          <div style={{ animation: "slideUp 0.35s ease" }}>
            ...
            <p className="text-[12px] font-medium mb-0.5" style={{ color: "#8a8a8a" }}>생년월일</p>
            <h2 className="text-[20px] mb-3" style={{ color: TEXT_CLR }}>
    ...
    <>
      <div className="px-6 pt-4 pb-3" style={{ backgroundColor: CARD_BG }}>
        ...
        <h2 className="text-[20px] mb-4" style={{ color: TEXT_CLR }}>
          <span className="font-bold" style={{ color: TEXT_CLR }}>{name ?? "그대"}님의 </span>
  ...
  return (
    <div className="relative flex flex-col items-center justify-center" style={{ minHeight: "100dvh", backgroundColor: "#080a0f" }}>
      ...
      <div className="relative z-10 px-8 w-full max-w-sm text-center">
        <p className="text-[22px] font-black mb-1" style={{ color: "#fff" }}>{name}님의 재물운</p>
