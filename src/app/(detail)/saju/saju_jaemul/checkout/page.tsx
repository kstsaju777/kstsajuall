...
const WHITE    = "#ffffff";
const RED      = "#f9dc64";
const RED_SOFT = "#f0c930";
const RED_PALE = "#fffbee";
const ROSE     = "#f0c930";
const GRAY1    = "#1a1a1a";
const GRAY2    = "#444444";
const GRAY3    = "#888888";
  ...
  return (
    <div className="rounded-2xl overflow-hidden"
      ...
      <div className="py-2.5 text-center" style={{ backgroundColor: RED_PALE, borderBottom: `1px solid ${ROSE}` }}>
        <p className="text-[15px] font-bold" style={{ color: "#8a7200" }}>{label}</p>
      </div>
      <div className="p-3">
        <div className="grid grid-cols-4 gap-1.5">
          {(pillars ?? Array(4).fill(null)).map((p, i) => (
            <div key={i} className="flex flex-col items-center gap-0">
              ...
              <span style={{ fontSize: 13, color: "#8a7200", lineHeight: 1, marginBottom: 6 }}>{p?.stemSs || " "}</span>
              ...
              <span style={{ fontSize: 13, color: "#8a7200", lineHeight: 1, marginTop: 6 }}>{p?.branchSs || " "}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      ...
      <div className="px-6 pt-10 pb-5 text-center">
        <p className="text-[11px] tracking-[0.2em] mb-3 font-medium" style={{ color: "#8a7200" }}>재물사주 · 정밀 리포트</p>
        <h1 className="text-[26px] font-black leading-snug" style={{ color: GRAY1 }}>
          {name}님의 재물운,<br />
          사주가 <span style={{ color: "#8a7200" }}>모두</span> 알고 있소
        </h1>
        <p className="text-[13px] mt-3 leading-relaxed" style={{ color: GRAY2 }}>
          타고난 재물 기질과 돈이 오는 시기를<br />
          낱낱이 풀었소. 지금 확인하시오.
        </p>
      </div>
      ...
      <div className="relative overflow-hidden w-full" style={{ aspectRatio: "9/16" }}>
        ...
        <video
          src="/media/cards/saju_jaemul/jaemul-0.mp4"
  ...
  return (
    <div style={{ backgroundColor: WHITE }}>
      <div className="px-5 pb-2 pt-6">
        <p className="text-center text-[13px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#8a7200" }}>✦ 사주 명식 ✦</p>
...
const PREVIEW_SECTIONS = [
  {
    icon: "💡", title: "나의 타고난 재물 기질", free: true,
    content: "일간과 오행 구성을 바탕으로 타고난 재물 기질을 분석합니다. 돈을 버는 방식, 쓰는 패턴, 저축력까지 사주 속에 고스란히 담겨 있습니다.\n\n재물이 쌓이는 방식과 새어나가는 패턴까지 사주는 조용히 기록하고 있습니다.",
    blurLines: [],
  },
  {
    ...
    content: "",
    blurLines: [
      "████년 ████월, 재물운이 가장 강하게 들어옵니다.",
      "이 시기에 ████한 행동이 큰 기회를 만듭니다.",
      "다음 재물 파동은 ████년 이후로 이어집니다.",
    ],
  },
  {
    icon: "📈", title: "지금 내 재물운", free: false,
    content: "",
    blurLines: [
      "현재 당신의 재물운은 ████ 상태입니다.",
      "지금 하는 일에서 ████한 기운이 작용합니다.",
      "████한 접근이 재물운을 더 활성화시킵니다.",
    ],
  },
  {
    icon: "🏦", title: "재물 시기와 대운 흐름", free: false,
    content: "",
    blurLines: [
      "현재 대운은 ████으로 재물에 ████한 기운이 작용합니다.",
      "████년 ████월은 재물이 크게 들어오는 특별한 시기입니다.",
      "이 시기를 놓치면 다음 기회는 ████년 이후로 밀립니다.",
    ],
  },
  {
    icon: "⚡", title: "재물을 방해하는 요인", free: false,
    content: "",
    blurLines: [
      "당신의 사주에서 ████살이 재물을 방해하고 있습니다.",
      "████한 지출 습관과 ████한 투자는 반드시 피하세요.",
    ...
    <div className="mx-5 mb-4 rounded-2xl overflow-hidden"
      ...
      <div className="flex items-center gap-2.5 px-4 py-3.5"
        ...
        <span className="ml-auto text-[10px] px-2.5 py-0.5 rounded-full font-medium"
          style={{ backgroundColor: s.free ? `${RED}30` : "#f5f5f5", color: s.free ? "#8a7200" : GRAY3, border: `1px solid ${s.free ? RED : GRAY4}` }}>
          {s.free ? "✓ 공개" : "🔒 잠김"}
        </span>
      </div>
          ...
          <div className="relative py-1">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
              <div className="w-9 h-9 rounded-full flex items-center justify-center"
                ...
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8a7200" strokeWidth="2.5">
                  <rect x="3" y="11" width="18" height="11" rx="2"/>
                  <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
                </svg>
              </div>
              <span className="text-[11px] font-semibold" style={{ color: "#8a7200" }}>결제 후 열람 가능</span>
            </div>
          </div>
        )}
      </div>
...
const CHAPTER_LIST = [
  ...
  { ch: 2,  title: "재물 기질",         emoji: "💡" },
  { ch: 3,  title: "돈 버는 방식",      emoji: "💰" },
  { ch: 4,  title: "지출 패턴",         emoji: "💸" },
  { ch: 5,  title: "직업과 재물",       emoji: "👔" },
  { ch: 6,  title: "투자와 사업",       emoji: "📈" },
  { ch: 7,  title: "재물 주의 시기",    emoji: "⚠️" },
  { ch: 8,  title: "대운 재물 흐름",    emoji: "🌊" },
  { ch: 9,  title: "귀인과 도움",       emoji: "✨" },
  { ch: 10, title: "재물 방해 요인",    emoji: "⚡" },
  { ch: 11, title: "부동산과 재산",     emoji: "🏠" },
  { ch: 12, title: "노년 재물운",       emoji: "🧓" },
      ...
      <div className="space-y-2">
        {CHAPTER_LIST.map(({ ch, title, emoji }, i) => (
          <div key={ch} className="flex items-center gap-3 px-3 py-2.5 rounded-xl"
            ...
            <span className="text-[12px] font-medium flex-shrink-0" style={{ color: "#8a7200", minWidth: 32 }}>제{ch}장</span>
...
// ─── 후기 섹션 ───────────────────────────────────────────────────────────────
const REVIEWS = [
  { star: 5, text: "재물 패턴이 이렇게 정확하게 나올 줄 몰랐어요. 돈이 새는 이유를 이제야 이해했습니다.", name: "30대 직장인 김○○", date: "2025.05.12" },
  { star: 5, text: "돈이 들어오는 시기가 딱 맞았어요. 미리 준비했더니 정말 좋은 기회가 왔습니다.", name: "40대 자영업자 이○○", date: "2025.04.28" },
  { star: 5, text: "투자 타이밍 분석이 정말 좋았어요. 왜 그때 손해가 났는지 이제야 이해가 됐습니다.", name: "30대 직장인 박○○", date: "2025.05.03" },
  { star: 5, text: "막연하게 불안했는데, 내 재물운이 어떤지 딱 짚어줘서 앞으로 방향이 명확해졌어요.", name: "50대 주부 최○○", date: "2025.06.01" },
];

function ReviewSection() {
  return (
    <div className="px-5 py-7" style={{ backgroundColor: CREAM }}>
      <p className="text-center text-[11px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#8a7200" }}>✦ 실제 후기 ✦</p>
...
function FAQSection() {
  ...
  return (
    <div className="px-5 py-7" style={{ backgroundColor: WHITE }}>
      <p className="text-center text-[11px] tracking-[0.2em] mb-1 font-medium" style={{ color: "#8a7200" }}>✦ FAQ ✦</p>
          ...
          <div key={i} className="rounded-2xl overflow-hidden"
            ...
            <button
              ...
              <span className="flex-shrink-0 text-[18px] font-light transition-transform duration-200"
                style={{ color: "#8a7200", transform: openIdx === i ? "rotate(45deg)" : "rotate(0deg)" }}>+</span>
            </button>
            {openIdx === i && (
...
// ─── 결제 모달 ────────────────────────────────────────────────────────────────
const PRODUCT = { name: "재물사주", original: 39800, discount: 50, price: 19900 };
      ...
      <div className="fixed bottom-0 z-50 overflow-y-auto rounded-t-3xl"
        ...
        <div className="px-5 pt-2 pb-7">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-[18px] font-black" style={{ color: DTXT }}>재물사주 결제 안내</h3>
          ...
          <div className="inline-block text-[13px] font-bold px-3.5 py-1.5 rounded-full mb-5"
            style={{ background: "rgba(249,220,100,0.16)", border: `1px solid ${ACCENT}55`, color: "#f9dc64" }}>
          ...
          <div className="mb-5">
            <div className="w-full text-left rounded-2xl px-4 py-3.5"
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  <span className="text-[14.5px] font-bold" style={{ color: DTXT }}>재물사주</span>
                  <p className="text-[11.5px] mt-1" style={{ color: DMUTE }}>홍연이 들려주는 나의 재물 이야기</p>
                </div>
          ...
          <button onClick={onConfirm}
            ...
            style={{ background: "linear-gradient(135deg, #f9dc64, #f0c930)", color: "#1a1200", boxShadow: "0 6px 20px rgba(249,220,100,0.4)" }}>
            결제하기
          </button>
          <div className="flex items-center justify-center gap-2 mt-3.5">
            <span className="flex-shrink-0 flex items-center justify-center rounded"
              style={{ width: 16, height: 16, background: ACCENT, color: "#1a1200", fontSize: 10 }}>✓</span>
        ...
        <div className="fixed z-[60] px-6"
          ...
          <div className="relative mx-auto rounded-2xl px-5 py-4"
            ...
            <button onClick={() => setConfirmExit(false)}
              ...
              style={{ background: "linear-gradient(135deg, #f9dc64, #f0c930)", color: "#1a1200" }}>혜택 받고 계속하기</button>
...
const TIME_COLORS: Record<string, string> = {
  "방금": "#f9dc64", "방금 전": "#f9dc64",
  "1분 전": "#f0c930", "2분 전": "#f0c930",
      ...
      <div style={{ position: "fixed", bottom: 100, right: "max(8px, calc(50vw - 232px))", zIndex: 49, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, pointerEvents: "none" }}>
        {toasts.map((t) => (
          <div key={t.id} style={{ animation: "toastInRight 0.35s ease", display: "flex", alignItems: "center", gap: 6, backgroundColor: "rgba(0,0,0,0.7)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 9999, padding: "6px 14px", fontSize: 12, color: "#fff", whiteSpace: "nowrap", backdropFilter: "blur(6px)" }}>
            <span style={{ backgroundColor: TIME_COLORS[t.time] ?? "#f0c930", color: "#1a1200", fontSize: 10, fontWeight: 700, borderRadius: 9999, padding: "2px 7px" }}>{t.time}</span>
...
function StickyPayCTA({ onPay, name }: { onPay: () => void; name: string }) {
  ...
  return (
    <div className="fixed bottom-0 flex items-center gap-3 px-4 z-50"
      ...
      {/* 오른쪽: 버튼 */}
      <style>{`
        @keyframes jaemulBtnNeon {
          0%   { background: #f9dc64; box-shadow: 0 0 12px 3px rgba(249,220,100,0.7); }
          33%  { background: #f0c930; box-shadow: 0 0 12px 3px rgba(240,201,48,0.7); }
          66%  { background: #fff3a0; box-shadow: 0 0 12px 3px rgba(255,243,160,0.7); }
          100% { background: #f9dc64; box-shadow: 0 0 12px 3px rgba(249,220,100,0.7); }
        }
        @keyframes jaemulBtnBeat {
      ...
      <button onClick={onPay}
        ...
        style={{ color: "#1a1200", animation: "jaemulBtnNeon 3s ease-in-out infinite, jaemulBtnBeat 2s ease-in-out infinite" }}>
        재물사주 확인하기
      </button>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 px-8"
      ...
      <style>{`
        ...
        @keyframes glow-pulse { 0%,100%{box-shadow:0 0 8px 2px #f9dc64aa,0 0 20px 4px #f0c93055} 50%{box-shadow:0 0 16px 4px #fff3a0cc,0 0 40px 10px #f9dc6488} }
      ...
      <p key={currentChapter} className="text-[13px] mb-8" style={{ color: "#f9dc64", animation: "title-fade 4s ease-in-out", minHeight: 20 }}>
...
function CheckoutContent() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        router.push(`/saju/saju_jaemul/report-preview?${new URLSearchParams({ name, gender }).toString()}`);
        return;
      }
...
export default function SajuJaemulCheckoutPage() {
  return (
    <Suspense fallback={
