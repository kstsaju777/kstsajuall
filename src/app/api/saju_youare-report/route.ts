...
async function generateConcernAdvice(id: string) {
  ...
  const user = `다음은 ${name1}의 유아사주 만세력이오.\n\n${manseryeokText}\n\n[고민에 대한 명리학적 조언 작성]\n고민: "${concern}"\n\n아래 JSON 형식으로만 답하오:\n{\n  "concernAdvice": {\n    "paragraphs": [\n      "고민을 아이의 명식(일간·오행·십성)과 연결한 풀이 — 이 고민이 왜 생겼는지 명식 구조로 설명 (3~4문장, 150자 이상)",\n      "명식에서 이 고민을 해결할 수 있는 힘과 방향 — 용신·희신 또는 강한 오행을 활용한 구체적 돌파구 (3~4문장, 150자 이상)",\n      "지금 당장 부모님이 실천할 수 있는 조언과 마음가짐 (2~3문장, 100자 이상)"\n    ]\n  }\n}\n\n고민의 주제(발달·건강·기질·교육 등)에 상관없이 반드시 작성하오. 세운·대운은 언급하지 마오. 홍연 말투(~이오/~하오/~겠소).`;
