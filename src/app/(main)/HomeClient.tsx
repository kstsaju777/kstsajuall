...
import { useCategory } from "@/components/layout/CategoryContext";
    ...
    return (
      <div className="px-3 pt-4 pb-20">
        ...
        <div className="flex flex-col gap-3">
          {cards.map((card, i) => {
            const isDev = card.href !== "/saju/total" && card.href !== "/saju/kunghap_yeonae" && !isAdmin;
            const cardInner = <>
              ...
              <div key={cat.tag} style={{ padding: isHot ? "16px 0 20px" : "0 0 4px", marginBottom: isHot ? 32 : 0, position: "relative" }}>
                ...
                <HotCarousel cardW={cardW} gap={10}>
                  {catProducts.map((product, i) => {
                    ...
                    const isDev = product.slug !== "total" && product.slug !== "kunghap_yeonae" && !isAdmin;
        ...
        {products.map((product, i) => {
          ...
          return (
            ...
            >
              ...
              {isCurrent && !isAdmin && product.slug !== "total" && product.slug !== "kunghap_yeonae" && (
              ...
              {isCurrent && !(product.slug !== "total" && product.slug !== "kunghap_yeonae" && !isAdmin) && (
